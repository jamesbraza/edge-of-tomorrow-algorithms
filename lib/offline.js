(!(function (e) {
  ...
  ((t.prototype = {
    ...
    (n.prototype = {
      ...
      _shouldPropagate: !0,
      active: !0,
      _registerListener: function (e, r, n, i) {
        var a,
          o = this._indexOfListener(e, n);
        if (-1 !== o) {
          if ((a = this._bindings[o]).isOnce() !== r)
            throw new Error(
              "You cannot add" +
                (r ? "" : "Once") +
                "() then add" +
        ...
        } else ((a = new t(this, e, r, n, i)), this._addBinding(a));
        return (
      ...
      _indexOfListener: function (e, t) {
        for (var r, n = this._bindings.length; n--; )
          if ((r = this._bindings[n])._listener === e && r.context === t)
            return n;
        return -1;
      },
      has: function (e, t) {
      ...
      dispatch: function () {
        if (this.active) {
          ...
          if ((this.memorize && (this._prevParams = t), r)) {
            ((e = this._bindings.slice()), (this._shouldPropagate = !0));
            do {
              r--;
            } while (e[r] && this._shouldPropagate && !1 !== e[r].execute(t));
          }
        }
      },
      forget: function () {
    ...
    return (function () {
      ...
      function t(e) {
        for (var t = 0; t < Y.length; t += 2)
          if (e >= Y[t] && e <= Y[t + 1]) return !0;
        return !1;
      }
      function r(e, r, n) {
        if (!Z[r])
          throw new Error("Font metrics not found for font: " + r + ".");
        var i = e.charCodeAt(0),
          a = Z[r][i];
        if (
          (!a && e[0] in Q && ((i = Q[e[0]].charCodeAt(0)), (a = Z[r][i])),
          a || "text" !== n || (t(i) && (a = Z[r][77])),
          a)
        )
          return {
            depth: a[0],
      ...
      function i(e, t, r, n, i, a) {
        ((Me[e][i] = { font: t, group: r, replace: n }),
          a && n && (Me[e][n] = Me[e][i]));
      }
      function a(e) {
        for (
      ...
      function s(e, t) {
        var r = Bt(["base"], e, t),
          n = Bt(["strut"]);
        return (
          (n.style.height = ce(r.height + r.depth)),
          r.depth && (n.style.verticalAlign = ce(-r.depth)),
      ...
      function l(e, t) {
        ...
        for (var a, o = [], l = [], h = 0; h < i.length; h++)
          if (
            (l.push(i[h]),
            i[h].hasClass("mbin") ||
              i[h].hasClass("mrel") ||
              i[h].hasClass("allowbreak"))
          ) {
            for (
              var c = !1;
              h < i.length - 1 &&
              i[h + 1].hasClass("mspace") &&
              !i[h + 1].hasClass("newline");

            )
              (h++, l.push(i[h]), i[h].hasClass("nobreak") && (c = !0));
            c || (o.push(s(l, t)), (l = []));
          } else
            i[h].hasClass("newline") &&
              (l.pop(),
              l.length > 0 && (o.push(s(l, t)), (l = [])),
              o.push(i[h]));
        (l.length > 0 && o.push(s(l, t)),
          r
            ? (((a = s(It(r, t, !0))).classes = ["tag"]), o.push(a))
            : n && o.push(n));
        var u = Bt(["katex-html"], o);
        if ((u.setAttribute("aria-hidden", "true"), a)) {
          var m = a.children[0];
          ((m.style.height = ce(u.height + u.depth)),
            u.depth && (m.style.verticalAlign = ce(-u.depth)));
        }
        return u;
      }
      function h(e) {
      ...
      function f(e, t) {
        ...
        return (
          "minner" === e.mclass
            ? (r = new Gt.MathNode("mpadded", n))
            : "mord" === e.mclass
              ? e.isCharacterBox
                ? ((r = n[0]).type = "mi")
                : (r = new Gt.MathNode("mi", n))
              : (e.isCharacterBox
                  ? ((r = n[0]).type = "mo")
                  : (r = new Gt.MathNode("mo", n)),
                "mbin" === e.mclass
      ...
      function g(e, t, r) {
        ...
        switch (n) {
          ...
          case "\\uparrow":
          case "\\downarrow":
            var i = { type: "atom", text: n, mode: "math", family: "rel" },
              a = {
                type: "ordgroup",
                mode: "math",
                body: [
                  r.callFunction("\\\\cdleft", [t[0]], []),
                  r.callFunction("\\Big", [i], []),
      ...
      function v(e, t) {
        var r = d(e);
        if (r && I.contains(_r, r.text)) return r;
        throw new B(
          r
      ...
      function S(e, t, r) {
        ...
        function i() {
          x &&
            (e.gullet.macros.get("\\df@tag")
              ? (x.push(e.subparse([new Yr("\\df@tag")])),
                e.gullet.macros.set("\\df@tag", void 0, !0))
              : x.push(Boolean(c) && "1" === e.gullet.macros.get("\\@eqnsw")));
        }
        var a = t.hskipBeforeAndAfter,
          o = t.addJot,
          s = t.cols,
          l = t.arraystretch,
          h = t.colSeparationType,
          c = t.autoTag,
          u = t.singleRow,
          m = t.emptySingleRow,
          d = t.maxNumCols,
        ...
        if (
          (e.gullet.beginGroup(),
          u || e.gullet.macros.set("\\cr", "\\\\\\relax"),
          !l)
        ) {
          var f = e.gullet.expandMacroAsText("\\arraystretch");
          if (null == f) l = 1;
          else if (!(l = parseFloat(f)) || l < 0)
        ...
        for (n(), b.push(w(e)); ; ) {
          ...
          if ("&" === S) {
            if (d && g.length === d) {
              if (u || h)
                throw new B("Too many tab characters: &", e.nextToken);
            ...
            if ("\\\\" !== S)
              throw new B("Expected & or \\\\ or \\cr or \\end", e.nextToken);
            e.consume();
            var A = void 0;
            (" " !== e.gullet.future().text && (A = e.parseSizeGroup(!0)),
              y.push(A ? A.value : null),
              i(),
              b.push(w(e)),
              (g = []),
              v.push(g),
      ...
      function M(e, t, r) {
        for (
          var n = It(e, t, !1), i = t.sizeMultiplier / r.sizeMultiplier, a = 0;
          a < n.length;
          a++
        ) {
          ...
          (o < 0
            ...
            : n[a].classes[o + 1] === "reset-size" + t.size &&
              (n[a].classes[o + 1] = "reset-size" + r.size),
            (n[a].height *= i),
            (n[a].depth *= i));
        }
        return yt.makeFragment(n);
      }
      var z = {
          d: function (e, t) {
            for (var r in t)
        ...
        if (a && a.start <= a.end) {
          ...
          ((r = a.start),
            ...
            r === o.length
              ? (i += " at end of input: ")
              : (i += " at position " + (r + 1) + ": "));
          var s = o.slice(r, n).replace(/[^]/g, "$&\u0332");
          i +=
            (r > 15 ? "\u2026" + o.slice(r - 15, r) : o.slice(0, r)) +
            s +
            (n + 15 < o.length ? o.slice(n, n + 15) + "\u2026" : o.slice(n));
        }
        var l = new Error(i);
        return (
          (l.name = "ParseError"),
          (l.__proto__ = ii.prototype),
          (l.position = r),
          null != r && null != n && (l.length = n - r),
          (l.rawMessage = e),
          l
        );
      };
      ...
      var B = C,
        ...
        I = {
          ...
          escape: function (e) {
            return String(e).replace(q, function (e) {
              return N[e];
            });
          },
        ...
        R = (function () {
          function t(t) {
            for (var r in ((this.displayMode = void 0),
            (this.output = void 0),
            (this.leqno = void 0),
            (this.fleqn = void 0),
          ...
          var r = t.prototype;
          return (
            (r.reportNonstrict = function (e, t, r) {
              var n = this.strict;
              if (
            ...
            (r.useStrictBehavior = function (e, t, r) {
              var n = this.strict;
        ...
        G = [1, 1, 3, 3, 5, 5, 7, 7],
        j = [0, 1, 2, 3, 2, 3, 2, 3],
        U = { DISPLAY: D[0], TEXT: D[2], SCRIPT: D[4], SCRIPTSCRIPT: D[6] },
        W = [
          {
            name: "latin",
            blocks: [
      ...
      var X = 80,
        ...
        re = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
        ne = function (e, t) {
        ...
        ie = (function () {
          function e(t) {
            ((this.style = void 0),
              ...
              (this.sizeMultiplier = re[this.size - 1]),
          ...
          return (
            ...
            (t.havingStyle = function (e) {
              return this.style === e
                ? this
                : this.extend({ style: e, size: ne(this.textSize, e) });
            }),
              ...
              return (
                this._fontMetrics ||
                  (this._fontMetrics = (function (e) {
                    var t;
                    if (!ee[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                      var r = (ee[t] = { cssEmPerMu: J.quad[t] / 18 });
                      for (var n in J) J.hasOwnProperty(n) && (r[n] = J[n][t]);
                    }
                    return ee[t];
                  })(this.size)),
                this._fontMetrics
      ...
      var ae = ie,
        ...
        de = function (e) {
          ...
          for (var r in ((t.className = ue(this.classes)), this.style))
        ...
        pe = function (e) {
          var t = "<" + e;
          this.classes.length &&
            (t += ' class="' + I.escape(ue(this.classes)) + '"');
          var r = "";
          for (var n in this.style)
            this.style.hasOwnProperty(n) &&
              (r += I.hyphenate(n) + ":" + this.style[n] + ";");
          for (var i in (r && (t += ' style="' + I.escape(r) + '"'),
          this.attributes))
          ...
          return (
            ...
            (t.toNode = function () {
              ...
              for (var r in (this.italic > 0 &&
                ((t = document.createElement("span")).style.marginRight = ce(
                  this.italic,
                )),
              this.classes.length > 0 &&
                ((t = t || document.createElement("span")).className = ue(
                  this.classes,
                )),
              this.style))
                this.style.hasOwnProperty(r) &&
            ...
            (t.toNode = function () {
              ...
              return (
                this.alternate
                  ...
                  : e.setAttribute("d", $[this.pathName]),
                e
              );
            }),
            (t.toMarkup = function () {
        ...
        Se = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
        Ae = {
          "accent-token": 1,
          mathord: 1,
          "op-token": 1,
      ...
      (i(Te, Be, Pe, "\u2261", "\\equiv", !0),
        ...
        i(Te, Be, Pe, "\u22c8", "\\bowtie", !0),
        i(Te, Be, Pe, "\u2323", "\\smile", !0),
        i(Te, Be, Pe, "\u2291", "\\sqsubseteq", !0),
        i(Te, Be, Pe, "\u2292", "\\sqsupseteq", !0),
        i(Te, Be, Pe, "\u2250", "\\doteq", !0),
        i(Te, Be, Pe, "\u2322", "\\frown", !0),
        i(Te, Be, Pe, "\u220b", "\\ni", !0),
        i(Te, Be, Pe, "\u221d", "\\propto", !0),
        ...
        i(Te, Be, _e, "\u2113", "\\ell", !0),
        i(Te, Be, _e, "\u266e", "\\natural", !0),
        i(Te, Be, _e, "\u2663", "\\clubsuit", !0),
        i(Te, Be, _e, "\u2118", "\\wp", !0),
        i(Te, Be, _e, "\u266f", "\\sharp", !0),
        i(Te, Be, _e, "\u2662", "\\diamondsuit", !0),
        i(Te, Be, _e, "\u211c", "\\Re", !0),
        i(Te, Be, _e, "\u2661", "\\heartsuit", !0),
        i(Te, Be, _e, "\u2111", "\\Im", !0),
        i(Te, Be, _e, "\u2660", "\\spadesuit", !0),
        i(Te, Be, _e, "\xa7", "\\S", !0),
        i(Ce, Be, _e, "\xa7", "\\S"),
        i(Te, Be, _e, "\xb6", "\\P", !0),
        i(Ce, Be, _e, "\xb6", "\\P"),
        i(Te, Be, _e, "\u2020", "\\dag"),
        i(Ce, Be, _e, "\u2020", "\\dag"),
        i(Ce, Be, _e, "\u2020", "\\textdagger"),
        i(Te, Be, _e, "\u2021", "\\ddag"),
        i(Ce, Be, _e, "\u2021", "\\ddag"),
        i(Ce, Be, _e, "\u2021", "\\textdaggerdbl"),
        i(Te, Be, Ee, "\u23b1", "\\rmoustache", !0),
        i(Te, Be, He, "\u23b0", "\\lmoustache", !0),
        i(Te, Be, Ee, "\u27ef", "\\rgroup", !0),
        i(Te, Be, He, "\u27ee", "\\lgroup", !0),
        i(Te, Be, qe, "\u2213", "\\mp", !0),
        i(Te, Be, qe, "\u2296", "\\ominus", !0),
        ...
        i(Te, Be, qe, "\u2217", "\\ast"),
        i(Te, Be, qe, "\u2294", "\\sqcup", !0),
        i(Te, Be, qe, "\u25ef", "\\bigcirc", !0),
        i(Te, Be, qe, "\u2219", "\\bullet", !0),
        i(Te, Be, qe, "\u2021", "\\ddagger"),
        i(Te, Be, qe, "\u2240", "\\wr", !0),
        i(Te, Be, qe, "\u2a3f", "\\amalg"),
        i(Te, Be, qe, "&", "\\And"),
        i(Te, Be, Pe, "\u27f5", "\\longleftarrow", !0),
        i(Te, Be, Pe, "\u21d0", "\\Leftarrow", !0),
        i(Te, Be, Pe, "\u27f8", "\\Longleftarrow", !0),
        i(Te, Be, Pe, "\u27f6", "\\longrightarrow", !0),
        i(Te, Be, Pe, "\u21d2", "\\Rightarrow", !0),
        i(Te, Be, Pe, "\u27f9", "\\Longrightarrow", !0),
        i(Te, Be, Pe, "\u2194", "\\leftrightarrow", !0),
        i(Te, Be, Pe, "\u27f7", "\\longleftrightarrow", !0),
        i(Te, Be, Pe, "\u21d4", "\\Leftrightarrow", !0),
        i(Te, Be, Pe, "\u27fa", "\\Longleftrightarrow", !0),
        i(Te, Be, Pe, "\u21a6", "\\mapsto", !0),
        i(Te, Be, Pe, "\u27fc", "\\longmapsto", !0),
        i(Te, Be, Pe, "\u2197", "\\nearrow", !0),
        i(Te, Be, Pe, "\u21a9", "\\hookleftarrow", !0),
        i(Te, Be, Pe, "\u21aa", "\\hookrightarrow", !0),
        i(Te, Be, Pe, "\u2198", "\\searrow", !0),
        i(Te, Be, Pe, "\u21bc", "\\leftharpoonup", !0),
        i(Te, Be, Pe, "\u21c0", "\\rightharpoonup", !0),
        i(Te, Be, Pe, "\u2199", "\\swarrow", !0),
        i(Te, Be, Pe, "\u21bd", "\\leftharpoondown", !0),
        i(Te, Be, Pe, "\u21c1", "\\rightharpoondown", !0),
        i(Te, Be, Pe, "\u2196", "\\nwarrow", !0),
        i(Te, Be, Pe, "\u21cc", "\\rightleftharpoons", !0),
        i(Te, Le, Pe, "\u226e", "\\nless", !0),
        i(Te, Le, Pe, "\ue010", "\\@nleqslant"),
        i(Te, Le, Pe, "\ue011", "\\@nleqq"),
        i(Te, Le, Pe, "\u2a87", "\\lneq", !0),
        i(Te, Le, Pe, "\u2268", "\\lneqq", !0),
        i(Te, Le, Pe, "\ue00c", "\\@lvertneqq"),
        i(Te, Le, Pe, "\u22e6", "\\lnsim", !0),
        i(Te, Le, Pe, "\u2a89", "\\lnapprox", !0),
        i(Te, Le, Pe, "\u2280", "\\nprec", !0),
        i(Te, Le, Pe, "\u22e0", "\\npreceq", !0),
        i(Te, Le, Pe, "\u22e8", "\\precnsim", !0),
        i(Te, Le, Pe, "\u2ab9", "\\precnapprox", !0),
        i(Te, Le, Pe, "\u2241", "\\nsim", !0),
        i(Te, Le, Pe, "\ue006", "\\@nshortmid"),
        i(Te, Le, Pe, "\u2224", "\\nmid", !0),
        i(Te, Le, Pe, "\u22ac", "\\nvdash", !0),
        i(Te, Le, Pe, "\u22ad", "\\nvDash", !0),
        i(Te, Le, Pe, "\u22ea", "\\ntriangleleft"),
        i(Te, Le, Pe, "\u22ec", "\\ntrianglelefteq", !0),
        i(Te, Le, Pe, "\u228a", "\\subsetneq", !0),
        i(Te, Le, Pe, "\ue01a", "\\@varsubsetneq"),
        i(Te, Le, Pe, "\u2acb", "\\subsetneqq", !0),
        i(Te, Le, Pe, "\ue017", "\\@varsubsetneqq"),
        i(Te, Le, Pe, "\u226f", "\\ngtr", !0),
        i(Te, Le, Pe, "\ue00f", "\\@ngeqslant"),
        i(Te, Le, Pe, "\ue00e", "\\@ngeqq"),
        i(Te, Le, Pe, "\u2a88", "\\gneq", !0),
        i(Te, Le, Pe, "\u2269", "\\gneqq", !0),
        i(Te, Le, Pe, "\ue00d", "\\@gvertneqq"),
        i(Te, Le, Pe, "\u22e7", "\\gnsim", !0),
        i(Te, Le, Pe, "\u2a8a", "\\gnapprox", !0),
        i(Te, Le, Pe, "\u2281", "\\nsucc", !0),
        i(Te, Le, Pe, "\u22e1", "\\nsucceq", !0),
        i(Te, Le, Pe, "\u22e9", "\\succnsim", !0),
        i(Te, Le, Pe, "\u2aba", "\\succnapprox", !0),
        i(Te, Le, Pe, "\u2246", "\\ncong", !0),
        i(Te, Le, Pe, "\ue007", "\\@nshortparallel"),
        i(Te, Le, Pe, "\u2226", "\\nparallel", !0),
        i(Te, Le, Pe, "\u22af", "\\nVDash", !0),
        i(Te, Le, Pe, "\u22eb", "\\ntriangleright"),
        i(Te, Le, Pe, "\u22ed", "\\ntrianglerighteq", !0),
        i(Te, Le, Pe, "\ue018", "\\@nsupseteqq"),
        i(Te, Le, Pe, "\u228b", "\\supsetneq", !0),
        i(Te, Le, Pe, "\ue01b", "\\@varsupsetneq"),
        i(Te, Le, Pe, "\u2acc", "\\supsetneqq", !0),
        i(Te, Le, Pe, "\ue019", "\\@varsupsetneqq"),
        i(Te, Le, Pe, "\u22ae", "\\nVdash", !0),
        i(Te, Le, Pe, "\u2ab5", "\\precneqq", !0),
        i(Te, Le, Pe, "\u2ab6", "\\succneqq", !0),
        i(Te, Le, Pe, "\ue016", "\\@nsubseteqq"),
        i(Te, Le, qe, "\u22b4", "\\unlhd"),
        i(Te, Le, qe, "\u22b5", "\\unrhd"),
        i(Te, Le, Pe, "\u219a", "\\nleftarrow", !0),
        i(Te, Le, Pe, "\u219b", "\\nrightarrow", !0),
        ...
        i(Te, Le, Pe, "\u21ae", "\\nleftrightarrow", !0),
        i(Te, Le, Pe, "\u21ce", "\\nLeftrightarrow", !0),
        i(Te, Le, Pe, "\u25b3", "\\vartriangle"),
        i(Te, Le, _e, "\u210f", "\\hslash"),
        i(Te, Le, _e, "\u25bd", "\\triangledown"),
        i(Te, Le, _e, "\u25ca", "\\lozenge"),
        i(Te, Le, _e, "\u24c8", "\\circledS"),
        i(Te, Le, _e, "\xae", "\\circledR"),
        i(Ce, Le, _e, "\xae", "\\circledR"),
        i(Te, Le, _e, "\u2221", "\\measuredangle", !0),
        i(Te, Le, _e, "\u2204", "\\nexists"),
        i(Te, Le, _e, "\u2127", "\\mho"),
        i(Te, Le, _e, "\u2132", "\\Finv", !0),
        i(Te, Le, _e, "\u2141", "\\Game", !0),
        i(Te, Le, _e, "\u2035", "\\backprime"),
        i(Te, Le, _e, "\u25b2", "\\blacktriangle"),
        i(Te, Le, _e, "\u25bc", "\\blacktriangledown"),
        i(Te, Le, _e, "\u25a0", "\\blacksquare"),
        i(Te, Le, _e, "\u29eb", "\\blacklozenge"),
        i(Te, Le, _e, "\u2605", "\\bigstar"),
        i(Te, Le, _e, "\u2222", "\\sphericalangle", !0),
        i(Te, Le, _e, "\u2201", "\\complement", !0),
        i(Te, Le, _e, "\xf0", "\\eth", !0),
        i(Ce, Be, _e, "\xf0", "\xf0"),
        i(Te, Le, _e, "\u2571", "\\diagup"),
        i(Te, Le, _e, "\u2572", "\\diagdown"),
        i(Te, Le, _e, "\u25a1", "\\square"),
        i(Te, Le, _e, "\u25a1", "\\Box"),
        i(Te, Le, _e, "\u25ca", "\\Diamond"),
        i(Te, Le, _e, "\xa5", "\\yen", !0),
        i(Ce, Le, _e, "\xa5", "\\yen", !0),
        i(Te, Le, _e, "\u2713", "\\checkmark", !0),
        i(Ce, Le, _e, "\u2713", "\\checkmark"),
        i(Te, Le, _e, "\u2136", "\\beth", !0),
        i(Te, Le, _e, "\u2138", "\\daleth", !0),
        i(Te, Le, _e, "\u2137", "\\gimel", !0),
        i(Te, Le, _e, "\u03dd", "\\digamma", !0),
        i(Te, Le, _e, "\u03f0", "\\varkappa"),
        i(Te, Le, He, "\u250c", "\\@ulcorner", !0),
        i(Te, Le, Ee, "\u2510", "\\@urcorner", !0),
        i(Te, Le, He, "\u2514", "\\@llcorner", !0),
        i(Te, Le, Ee, "\u2518", "\\@lrcorner", !0),
        i(Te, Le, Pe, "\u2266", "\\leqq", !0),
        i(Te, Le, Pe, "\u2a7d", "\\leqslant", !0),
        i(Te, Le, Pe, "\u2a95", "\\eqslantless", !0),
        i(Te, Le, Pe, "\u2272", "\\lesssim", !0),
        i(Te, Le, Pe, "\u2a85", "\\lessapprox", !0),
        i(Te, Le, Pe, "\u224a", "\\approxeq", !0),
        i(Te, Le, qe, "\u22d6", "\\lessdot"),
        i(Te, Le, Pe, "\u22d8", "\\lll", !0),
        i(Te, Le, Pe, "\u2276", "\\lessgtr", !0),
        i(Te, Le, Pe, "\u22da", "\\lesseqgtr", !0),
        i(Te, Le, Pe, "\u2a8b", "\\lesseqqgtr", !0),
        i(Te, Le, Pe, "\u2251", "\\doteqdot"),
        i(Te, Le, Pe, "\u2253", "\\risingdotseq", !0),
        i(Te, Le, Pe, "\u2252", "\\fallingdotseq", !0),
        i(Te, Le, Pe, "\u223d", "\\backsim", !0),
        i(Te, Le, Pe, "\u22cd", "\\backsimeq", !0),
        i(Te, Le, Pe, "\u2ac5", "\\subseteqq", !0),
        i(Te, Le, Pe, "\u22d0", "\\Subset", !0),
        i(Te, Le, Pe, "\u228f", "\\sqsubset", !0),
        i(Te, Le, Pe, "\u227c", "\\preccurlyeq", !0),
        i(Te, Le, Pe, "\u22de", "\\curlyeqprec", !0),
        i(Te, Le, Pe, "\u227e", "\\precsim", !0),
        i(Te, Le, Pe, "\u2ab7", "\\precapprox", !0),
        i(Te, Le, Pe, "\u22b2", "\\vartriangleleft"),
        i(Te, Le, Pe, "\u22b4", "\\trianglelefteq"),
        i(Te, Le, Pe, "\u22a8", "\\vDash", !0),
        i(Te, Le, Pe, "\u22aa", "\\Vvdash", !0),
        i(Te, Le, Pe, "\u2323", "\\smallsmile"),
        i(Te, Le, Pe, "\u2322", "\\smallfrown"),
        i(Te, Le, Pe, "\u224f", "\\bumpeq", !0),
        i(Te, Le, Pe, "\u224e", "\\Bumpeq", !0),
        i(Te, Le, Pe, "\u2267", "\\geqq", !0),
        i(Te, Le, Pe, "\u2a7e", "\\geqslant", !0),
        i(Te, Le, Pe, "\u2a96", "\\eqslantgtr", !0),
        i(Te, Le, Pe, "\u2273", "\\gtrsim", !0),
        i(Te, Le, Pe, "\u2a86", "\\gtrapprox", !0),
        i(Te, Le, qe, "\u22d7", "\\gtrdot"),
        i(Te, Le, Pe, "\u22d9", "\\ggg", !0),
        i(Te, Le, Pe, "\u2277", "\\gtrless", !0),
        i(Te, Le, Pe, "\u22db", "\\gtreqless", !0),
        i(Te, Le, Pe, "\u2a8c", "\\gtreqqless", !0),
        i(Te, Le, Pe, "\u2256", "\\eqcirc", !0),
        i(Te, Le, Pe, "\u2257", "\\circeq", !0),
        i(Te, Le, Pe, "\u225c", "\\triangleq", !0),
        i(Te, Le, Pe, "\u223c", "\\thicksim"),
        i(Te, Le, Pe, "\u2248", "\\thickapprox"),
        i(Te, Le, Pe, "\u2ac6", "\\supseteqq", !0),
        i(Te, Le, Pe, "\u22d1", "\\Supset", !0),
        i(Te, Le, Pe, "\u2290", "\\sqsupset", !0),
        i(Te, Le, Pe, "\u227d", "\\succcurlyeq", !0),
        i(Te, Le, Pe, "\u22df", "\\curlyeqsucc", !0),
        i(Te, Le, Pe, "\u227f", "\\succsim", !0),
        i(Te, Le, Pe, "\u2ab8", "\\succapprox", !0),
        i(Te, Le, Pe, "\u22b3", "\\vartriangleright"),
        i(Te, Le, Pe, "\u22b5", "\\trianglerighteq"),
        i(Te, Le, Pe, "\u22a9", "\\Vdash", !0),
        i(Te, Le, Pe, "\u2223", "\\shortmid"),
        i(Te, Le, Pe, "\u2225", "\\shortparallel"),
        i(Te, Le, Pe, "\u226c", "\\between", !0),
        i(Te, Le, Pe, "\u22d4", "\\pitchfork", !0),
        i(Te, Le, Pe, "\u221d", "\\varpropto"),
        i(Te, Le, Pe, "\u25c0", "\\blacktriangleleft"),
        i(Te, Le, Pe, "\u2234", "\\therefore", !0),
        i(Te, Le, Pe, "\u220d", "\\backepsilon"),
        i(Te, Le, Pe, "\u25b6", "\\blacktriangleright"),
        i(Te, Le, Pe, "\u2235", "\\because", !0),
        i(Te, Le, Pe, "\u22d8", "\\llless"),
        i(Te, Le, Pe, "\u22d9", "\\gggtr"),
        i(Te, Le, qe, "\u22b2", "\\lhd"),
        i(Te, Le, qe, "\u22b3", "\\rhd"),
        ...
        i(Te, Be, Pe, "\u22c8", "\\Join"),
        i(Te, Le, Pe, "\u2251", "\\Doteq", !0),
        i(Te, Le, qe, "\u2214", "\\dotplus", !0),
        i(Te, Le, qe, "\u2216", "\\smallsetminus"),
        i(Te, Le, qe, "\u22d2", "\\Cap", !0),
        i(Te, Le, qe, "\u22d3", "\\Cup", !0),
        i(Te, Le, qe, "\u2a5e", "\\doublebarwedge", !0),
        i(Te, Le, qe, "\u229f", "\\boxminus", !0),
        i(Te, Le, qe, "\u229e", "\\boxplus", !0),
        i(Te, Le, qe, "\u22c7", "\\divideontimes", !0),
        i(Te, Le, qe, "\u22c9", "\\ltimes", !0),
        i(Te, Le, qe, "\u22ca", "\\rtimes", !0),
        i(Te, Le, qe, "\u22cb", "\\leftthreetimes", !0),
        i(Te, Le, qe, "\u22cc", "\\rightthreetimes", !0),
        i(Te, Le, qe, "\u22cf", "\\curlywedge", !0),
        i(Te, Le, qe, "\u22ce", "\\curlyvee", !0),
        i(Te, Le, qe, "\u229d", "\\circleddash", !0),
        i(Te, Le, qe, "\u229b", "\\circledast", !0),
        i(Te, Le, qe, "\u22c5", "\\centerdot"),
        i(Te, Le, qe, "\u22ba", "\\intercal", !0),
        i(Te, Le, qe, "\u22d2", "\\doublecap"),
        i(Te, Le, qe, "\u22d3", "\\doublecup"),
        i(Te, Le, qe, "\u22a0", "\\boxtimes", !0),
        i(Te, Le, Pe, "\u21e2", "\\dashrightarrow", !0),
        i(Te, Le, Pe, "\u21e0", "\\dashleftarrow", !0),
        i(Te, Le, Pe, "\u21c7", "\\leftleftarrows", !0),
        i(Te, Le, Pe, "\u21c6", "\\leftrightarrows", !0),
        i(Te, Le, Pe, "\u21da", "\\Lleftarrow", !0),
        i(Te, Le, Pe, "\u219e", "\\twoheadleftarrow", !0),
        i(Te, Le, Pe, "\u21a2", "\\leftarrowtail", !0),
        i(Te, Le, Pe, "\u21ab", "\\looparrowleft", !0),
        i(Te, Le, Pe, "\u21cb", "\\leftrightharpoons", !0),
        i(Te, Le, Pe, "\u21b6", "\\curvearrowleft", !0),
        i(Te, Le, Pe, "\u21ba", "\\circlearrowleft", !0),
        i(Te, Le, Pe, "\u21b0", "\\Lsh", !0),
        i(Te, Le, Pe, "\u21c8", "\\upuparrows", !0),
        i(Te, Le, Pe, "\u21bf", "\\upharpoonleft", !0),
        i(Te, Le, Pe, "\u21c3", "\\downharpoonleft", !0),
        i(Te, Be, Pe, "\u22b6", "\\origof", !0),
        i(Te, Be, Pe, "\u22b7", "\\imageof", !0),
        i(Te, Le, Pe, "\u22b8", "\\multimap", !0),
        i(Te, Le, Pe, "\u21ad", "\\leftrightsquigarrow", !0),
        i(Te, Le, Pe, "\u21c9", "\\rightrightarrows", !0),
        i(Te, Le, Pe, "\u21c4", "\\rightleftarrows", !0),
        i(Te, Le, Pe, "\u21a0", "\\twoheadrightarrow", !0),
        i(Te, Le, Pe, "\u21a3", "\\rightarrowtail", !0),
        i(Te, Le, Pe, "\u21ac", "\\looparrowright", !0),
        i(Te, Le, Pe, "\u21b7", "\\curvearrowright", !0),
        i(Te, Le, Pe, "\u21bb", "\\circlearrowright", !0),
        i(Te, Le, Pe, "\u21b1", "\\Rsh", !0),
        i(Te, Le, Pe, "\u21ca", "\\downdownarrows", !0),
        i(Te, Le, Pe, "\u21be", "\\upharpoonright", !0),
        i(Te, Le, Pe, "\u21c2", "\\downharpoonright", !0),
        i(Te, Le, Pe, "\u21dd", "\\rightsquigarrow", !0),
        i(Te, Le, Pe, "\u21dd", "\\leadsto"),
        i(Te, Le, Pe, "\u21db", "\\Rrightarrow", !0),
        i(Te, Le, Pe, "\u21be", "\\restriction"),
        i(Te, Be, _e, "\u2018", "`"),
        i(Te, Be, _e, "$", "\\$"),
        i(Ce, Be, _e, "$", "\\$"),
        i(Ce, Be, _e, "$", "\\textdollar"),
        i(Te, Be, _e, "%", "\\%"),
        i(Ce, Be, _e, "%", "\\%"),
        i(Te, Be, _e, "_", "\\_"),
        i(Ce, Be, _e, "_", "\\_"),
        i(Ce, Be, _e, "_", "\\textunderscore"),
        i(Te, Be, _e, "\u2220", "\\angle", !0),
        i(Te, Be, _e, "\u221e", "\\infty", !0),
        i(Te, Be, _e, "\u2032", "\\prime"),
        i(Te, Be, _e, "\u25b3", "\\triangle"),
        i(Te, Be, _e, "\u0393", "\\Gamma", !0),
        i(Te, Be, _e, "\u0394", "\\Delta", !0),
        i(Te, Be, _e, "\u0398", "\\Theta", !0),
        i(Te, Be, _e, "\u039b", "\\Lambda", !0),
        i(Te, Be, _e, "\u039e", "\\Xi", !0),
        i(Te, Be, _e, "\u03a0", "\\Pi", !0),
        i(Te, Be, _e, "\u03a3", "\\Sigma", !0),
        i(Te, Be, _e, "\u03a5", "\\Upsilon", !0),
        i(Te, Be, _e, "\u03a6", "\\Phi", !0),
        i(Te, Be, _e, "\u03a8", "\\Psi", !0),
        i(Te, Be, _e, "\u03a9", "\\Omega", !0),
        i(Te, Be, _e, "A", "\u0391"),
        i(Te, Be, _e, "B", "\u0392"),
        i(Te, Be, _e, "E", "\u0395"),
        i(Te, Be, _e, "Z", "\u0396"),
        ...
        i(Te, Be, _e, "\u22a5", "\\bot"),
        i(Te, Be, _e, "\u2205", "\\emptyset"),
        i(Te, Le, _e, "\u2205", "\\varnothing"),
        i(Te, Be, Oe, "\u03b1", "\\alpha", !0),
        i(Te, Be, Oe, "\u03b2", "\\beta", !0),
        i(Te, Be, Oe, "\u03b3", "\\gamma", !0),
        i(Te, Be, Oe, "\u03b4", "\\delta", !0),
        i(Te, Be, Oe, "\u03f5", "\\epsilon", !0),
        i(Te, Be, Oe, "\u03b6", "\\zeta", !0),
        i(Te, Be, Oe, "\u03b7", "\\eta", !0),
        i(Te, Be, Oe, "\u03b8", "\\theta", !0),
        i(Te, Be, Oe, "\u03b9", "\\iota", !0),
        i(Te, Be, Oe, "\u03ba", "\\kappa", !0),
        i(Te, Be, Oe, "\u03bb", "\\lambda", !0),
        i(Te, Be, Oe, "\u03bc", "\\mu", !0),
        i(Te, Be, Oe, "\u03bd", "\\nu", !0),
        i(Te, Be, Oe, "\u03be", "\\xi", !0),
        i(Te, Be, Oe, "\u03bf", "\\omicron", !0),
        i(Te, Be, Oe, "\u03c0", "\\pi", !0),
        i(Te, Be, Oe, "\u03c1", "\\rho", !0),
        i(Te, Be, Oe, "\u03c3", "\\sigma", !0),
        i(Te, Be, Oe, "\u03c4", "\\tau", !0),
        i(Te, Be, Oe, "\u03c5", "\\upsilon", !0),
        i(Te, Be, Oe, "\u03d5", "\\phi", !0),
        i(Te, Be, Oe, "\u03c7", "\\chi", !0),
        i(Te, Be, Oe, "\u03c8", "\\psi", !0),
        i(Te, Be, Oe, "\u03c9", "\\omega", !0),
        i(Te, Be, Oe, "\u03b5", "\\varepsilon", !0),
        i(Te, Be, Oe, "\u03d1", "\\vartheta", !0),
        i(Te, Be, Oe, "\u03d6", "\\varpi", !0),
        i(Te, Be, Oe, "\u03f1", "\\varrho", !0),
        i(Te, Be, Oe, "\u03c2", "\\varsigma", !0),
        i(Te, Be, Oe, "\u03c6", "\\varphi", !0),
        i(Te, Be, qe, "\u2217", "*", !0),
        i(Te, Be, qe, "+", "+"),
        i(Te, Be, qe, "\u2212", "-", !0),
        i(Te, Be, qe, "\u22c5", "\\cdot", !0),
        i(Te, Be, qe, "\u2218", "\\circ", !0),
        i(Te, Be, qe, "\xf7", "\\div", !0),
        i(Te, Be, qe, "\xb1", "\\pm", !0),
        i(Te, Be, qe, "\xd7", "\\times", !0),
        i(Te, Be, qe, "\u2229", "\\cap", !0),
        i(Te, Be, qe, "\u222a", "\\cup", !0),
        i(Te, Be, qe, "\u2216", "\\setminus", !0),
        i(Te, Be, qe, "\u2227", "\\land"),
        i(Te, Be, qe, "\u2228", "\\lor"),
        i(Te, Be, qe, "\u2227", "\\wedge", !0),
        i(Te, Be, qe, "\u2228", "\\vee", !0),
        ...
        i(Te, Be, Pe, "\u2282", "\\subset", !0),
        i(Te, Be, Pe, "\u2283", "\\supset", !0),
        i(Te, Be, Pe, "\u2286", "\\subseteq", !0),
        i(Te, Be, Pe, "\u2287", "\\supseteq", !0),
        i(Te, Le, Pe, "\u2288", "\\nsubseteq", !0),
        i(Te, Le, Pe, "\u2289", "\\nsupseteq", !0),
        i(Te, Be, Pe, "\u22a8", "\\models"),
        i(Te, Be, Pe, "\u2190", "\\leftarrow", !0),
        ...
        i(Te, Le, Pe, "\u2270", "\\nleq", !0),
        i(Te, Be, Fe, "\xa0", "\\ "),
        i(Te, Be, Fe, "\xa0", "\\space"),
        i(Te, Be, Fe, "\xa0", "\\nobreakspace"),
        i(Ce, Be, Fe, "\xa0", "\\ "),
        i(Ce, Be, Fe, "\xa0", " "),
        i(Ce, Be, Fe, "\xa0", "\\space"),
        i(Ce, Be, Fe, "\xa0", "\\nobreakspace"),
        i(Te, Be, Fe, null, "\\nobreak"),
        i(Te, Be, Fe, null, "\\allowbreak"),
        i(Te, Be, De, ",", ","),
        i(Te, Be, De, ";", ";"),
        i(Te, Le, qe, "\u22bc", "\\barwedge", !0),
        i(Te, Le, qe, "\u22bb", "\\veebar", !0),
        i(Te, Be, qe, "\u2299", "\\odot", !0),
        i(Te, Be, qe, "\u2295", "\\oplus", !0),
        i(Te, Be, qe, "\u2297", "\\otimes", !0),
        i(Te, Be, _e, "\u2202", "\\partial", !0),
        i(Te, Be, qe, "\u2298", "\\oslash", !0),
        i(Te, Le, qe, "\u229a", "\\circledcirc", !0),
        i(Te, Le, qe, "\u22a1", "\\boxdot", !0),
        i(Te, Be, qe, "\u25b3", "\\bigtriangleup"),
        i(Te, Be, qe, "\u25bd", "\\bigtriangledown"),
        i(Te, Be, qe, "\u2020", "\\dagger"),
        i(Te, Be, qe, "\u22c4", "\\diamond"),
        i(Te, Be, qe, "\u22c6", "\\star"),
        i(Te, Be, qe, "\u25c3", "\\triangleleft"),
        i(Te, Be, qe, "\u25b9", "\\triangleright"),
        i(Te, Be, He, "{", "\\{"),
        i(Ce, Be, _e, "{", "\\{"),
        i(Ce, Be, _e, "{", "\\textbraceleft"),
        i(Te, Be, Ee, "}", "\\}"),
        i(Ce, Be, _e, "}", "\\}"),
        i(Ce, Be, _e, "}", "\\textbraceright"),
        i(Te, Be, He, "{", "\\lbrace"),
        i(Te, Be, Ee, "}", "\\rbrace"),
        i(Te, Be, He, "[", "\\lbrack", !0),
        i(Ce, Be, _e, "[", "\\lbrack", !0),
        ...
        i(Te, Be, He, "(", "\\lparen", !0),
        i(Te, Be, Ee, ")", "\\rparen", !0),
        i(Ce, Be, _e, "<", "\\textless", !0),
        i(Ce, Be, _e, ">", "\\textgreater", !0),
        i(Te, Be, He, "\u230a", "\\lfloor", !0),
        i(Te, Be, Ee, "\u230b", "\\rfloor", !0),
        i(Te, Be, He, "\u2308", "\\lceil", !0),
        i(Te, Be, Ee, "\u2309", "\\rceil", !0),
        i(Te, Be, _e, "\\", "\\backslash"),
        i(Te, Be, _e, "\u2223", "|"),
        i(Te, Be, _e, "\u2223", "\\vert"),
        i(Ce, Be, _e, "|", "\\textbar", !0),
        i(Te, Be, _e, "\u2225", "\\|"),
        i(Te, Be, _e, "\u2225", "\\Vert"),
        i(Ce, Be, _e, "\u2225", "\\textbardbl"),
        i(Ce, Be, _e, "~", "\\textasciitilde"),
        i(Ce, Be, _e, "\\", "\\textbackslash"),
        i(Ce, Be, _e, "^", "\\textasciicircum"),
        i(Te, Be, Pe, "\u2191", "\\uparrow", !0),
        i(Te, Be, Pe, "\u21d1", "\\Uparrow", !0),
        i(Te, Be, Pe, "\u2193", "\\downarrow", !0),
        i(Te, Be, Pe, "\u21d3", "\\Downarrow", !0),
        i(Te, Be, Pe, "\u2195", "\\updownarrow", !0),
        i(Te, Be, Pe, "\u21d5", "\\Updownarrow", !0),
        i(Te, Be, Re, "\u2210", "\\coprod"),
        i(Te, Be, Re, "\u22c1", "\\bigvee"),
        i(Te, Be, Re, "\u22c0", "\\bigwedge"),
        ...
        i(Te, Be, Re, "\u2a06", "\\bigsqcup"),
        i(Te, Be, Re, "\u222b", "\\smallint"),
        i(Ce, Be, Ie, "\u2026", "\\textellipsis"),
        i(Te, Be, Ie, "\u2026", "\\mathellipsis"),
        i(Ce, Be, Ie, "\u2026", "\\ldots", !0),
        i(Te, Be, Ie, "\u2026", "\\ldots", !0),
        i(Te, Be, Ie, "\u22ef", "\\@cdots", !0),
        i(Te, Be, Ie, "\u22f1", "\\ddots", !0),
        ...
        i(Ce, Be, Ne, "\xa8", '\\"'),
        i(Ce, Be, Ne, "\u02dd", "\\H"),
        i(Ce, Be, Ne, "\u25ef", "\\textcircled"));
      var Ve = { "--": !0, "---": !0, "``": !0, "''": !0 };
      (i(Ce, Be, _e, "\u2013", "--", !0),
        i(Ce, Be, _e, "\u2013", "\\textendash"),
        i(Ce, Be, _e, "\u2014", "---", !0),
        i(Ce, Be, _e, "\u2014", "\\textemdash"),
        i(Ce, Be, _e, "\u2018", "`", !0),
        i(Ce, Be, _e, "\u2018", "\\textquoteleft"),
        i(Ce, Be, _e, "\u2019", "'", !0),
        i(Ce, Be, _e, "\u2019", "\\textquoteright"),
        i(Ce, Be, _e, "\u201c", "``", !0),
        i(Ce, Be, _e, "\u201c", "\\textquotedblleft"),
        i(Ce, Be, _e, "\u201d", "''", !0),
        i(Ce, Be, _e, "\u201d", "\\textquotedblright"),
        i(Te, Be, _e, "\xb0", "\\degree", !0),
        i(Ce, Be, _e, "\xb0", "\\degree"),
        i(Ce, Be, _e, "\xb0", "\\textdegree", !0),
        i(Te, Be, _e, "\xa3", "\\pounds"),
        i(Te, Be, _e, "\xa3", "\\mathsterling", !0),
        i(Ce, Be, _e, "\xa3", "\\pounds"),
        i(Ce, Be, _e, "\xa3", "\\textsterling", !0),
        i(Te, Le, _e, "\u2720", "\\maltese"),
        i(Ce, Le, _e, "\u2720", "\\maltese"));
      for (var Ge = '0123456789/@."', je = 0; je < Ge.length; je++) {
        var Ue = Ge.charAt(je);
        i(Te, Be, _e, Ue, Ue);
      }
      for (var We = '0123456789!@*()-=+";:?/.,', Ye = 0; Ye < We.length; Ye++) {
        var Xe = We.charAt(Ye);
        i(Ce, Be, _e, Xe, Xe);
      }
      for (
        var $e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", Ke = 0;
        Ke < $e.length;
        Ke++
      ) {
        var Ze = $e.charAt(Ke);
        (i(Te, Be, Oe, Ze, Ze), i(Ce, Be, _e, Ze, Ze));
      }
      (i(Te, Le, _e, "C", "\u2102"),
        i(Ce, Le, _e, "C", "\u2102"),
        i(Te, Le, _e, "H", "\u210d"),
        ...
        i(Te, Be, Oe, "h", "\u210e"),
        i(Ce, Be, Oe, "h", "\u210e"));
      for (var Je = "", Qe = 0; Qe < $e.length; Qe++) {
        var et = $e.charAt(Qe);
        (i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56320 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56372 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56424 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56580 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56684 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56736 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56788 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56840 + Qe))),
          i(Ce, Be, _e, et, Je),
          i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56944 + Qe))),
          i(Ce, Be, _e, et, Je),
          Qe < 26 &&
            (i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56632 + Qe))),
            i(Ce, Be, _e, et, Je),
            i(Te, Be, Oe, et, (Je = String.fromCharCode(55349, 56476 + Qe))),
            i(Ce, Be, _e, et, Je)));
      }
      (i(Te, Be, Oe, "k", (Je = String.fromCharCode(55349, 56668))),
        i(Ce, Be, _e, "k", Je));
      for (var tt = 0; tt < 10; tt++) {
        var rt = tt.toString();
        (i(Te, Be, Oe, rt, (Je = String.fromCharCode(55349, 57294 + tt))),
          i(Ce, Be, _e, rt, Je),
          i(Te, Be, Oe, rt, (Je = String.fromCharCode(55349, 57314 + tt))),
          i(Ce, Be, _e, rt, Je),
          i(Te, Be, Oe, rt, (Je = String.fromCharCode(55349, 57324 + tt))),
          i(Ce, Be, _e, rt, Je),
          i(Te, Be, Oe, rt, (Je = String.fromCharCode(55349, 57334 + tt))),
          i(Ce, Be, _e, rt, Je));
      }
      for (var nt = "\xd0\xde\xfe", it = 0; it < nt.length; it++) {
        var at = nt.charAt(it);
        (i(Te, Be, Oe, at, at), i(Ce, Be, _e, at, at));
      }
      var ot = [
        ...
        lt = function (e, t, n) {
          return (
            ze[n][e] && ze[n][e].replace && (e = ze[n][e].replace),
            { value: e, metrics: r(e, t, n) }
          );
        },
        ht = function (e, t, r, n, i) {
          ...
          if (((e = o.value), s)) {
            ...
            (("text" === r || (n && "mathit" === n.font)) && (l = 0),
              (a = new be(e, s.height, s.depth, l, s.skew, s.width, i)));
          } else
            ("undefined" != typeof console &&
              console.warn(
        ...
        mt = function (e, t, r, n) {
          var i = new fe(e, t, r, n);
          return (ut(i), i);
        },
        dt = function (e, t, r, n) {
          return new fe(e, t, r, n);
        },
        pt = function (e) {
          var t = new K(e);
          return (ut(t), t);
        ...
        yt = {
          ...
          mathsym: function (e, t, r, n) {
            return (
              void 0 === n && (n = []),
              "boldsymbol" === r.font && lt(e, "Main-Bold", t).metrics
                ? ht(e, "Main-Bold", t, r, n.concat(["mathbf"]))
                : "\\" === e || "main" === ze[t][e].font
                  ? ht(e, "Main-Regular", t, r, n)
                  : ht(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
            );
          },
          makeSpan: mt,
          makeSvgSpan: dt,
          makeLineSpan: function (e, t, r) {
            ...
            return (
              ...
              (n.style.borderBottomWidth = ce(n.height)),
              (n.maxFontSize = 1),
              n
            );
          },
          makeAnchor: function (e, t, r, n) {
            var i = new ge(e, t, r, n);
            return (ut(i), i);
          },
          makeFragment: pt,
          wrapFragment: function (e, t) {
            return e instanceof K ? mt([], [e], t) : e;
          },
          makeVList: function (e) {
            for (
              var t = (function (e) {
            ...
            var l = mt(["pstrut"], []);
            l.style.height = ce(i);
            for (var h = [], c = n, u = n, m = n, d = 0; d < r.length; d++) {
              var p = r[d];
              if ("kern" === p.type) m += p.size;
              else {
                var f = p.elem,
                  g = p.wrapperClasses || [],
                  v = p.wrapperStyle || {},
                  y = mt(g, [l, f], void 0, v);
                ((y.style.top = ce(-i - m - f.depth)),
                  p.marginLeft && (y.style.marginLeft = p.marginLeft),
                  p.marginRight && (y.style.marginRight = p.marginRight),
                  h.push(y),
                  (m += f.height + f.depth));
              }
              ((c = Math.min(c, m)), (u = Math.max(u, m)));
            }
            var b,
              x = mt(["vlist"], h);
            if (((x.style.height = ce(u)), c < 0)) {
              var w = mt([], []),
                k = mt(["vlist"], [w]);
              k.style.height = ce(-c);
              var S = mt(["vlist-s"], [new be("\u200b")]);
              b = [mt(["vlist-r"], [x, S]), mt(["vlist-r"], [k])];
            } else b = [mt(["vlist-r"], [x])];
            var A = mt(["vlist-t"], b);
            return (
              2 === b.length && A.classes.push("vlist-t2"),
              (A.height = u),
              (A.depth = -c),
              A
            );
            ...
            if (55349 === i.charCodeAt(0)) {
              var c = (function (e, t) {
                ...
                if (119808 <= r && r < 120484) {
                  ...
                  return [ot[i][2], ot[i][n]];
                }
                if (120782 <= r && r <= 120831) {
                  var a = Math.floor((r - 120782) / 10);
                  return [st[a][2], st[a][n]];
                }
                if (120485 === r || 120486 === r) return [ot[0][2], ot[0][n]];
                if (120486 < r && r < 120782) return ["", ""];
                throw new B("Unsupported character: " + e);
              })(i, n);
              ((l = c[0]), (h = c[1]));
            }
            if (l.length > 0) return ht(i, l, n, t, a.concat(h));
            if (s) {
              var u, m;
              if ("boldsymbol" === s) {
                var d = (function (e, t, r, n, a) {
                  return "textord" !== a && lt(i, "Math-BoldItalic", t).metrics
                    ? { fontName: "Math-BoldItalic", fontClass: "boldsymbol" }
                    : { fontName: "Main-Bold", fontClass: "mathbf" };
                })(0, n, 0, 0, r);
                ((u = d.fontName), (m = [d.fontClass]));
              } else
                o
                  ? ((u = gt[s].fontName), (m = [s]))
                  : ((u = ft(s, t.fontWeight, t.fontShape)),
                    (m = [s, t.fontWeight, t.fontShape]));
              if (lt(i, u, n).metrics) return ht(i, u, n, t, a.concat(m));
              if (Ve.hasOwnProperty(i) && "Typewriter" === u.slice(0, 10)) {
                for (var p = [], f = 0; f < i.length; f++)
                  p.push(ht(i[f], u, n, t, a.concat(m)));
                return pt(p);
              }
            }
            if ("mathord" === r)
              return ht(i, "Math-Italic", n, t, a.concat(["mathnormal"]));
            if ("textord" === r) {
              var g = ze[n][i] && ze[n][i].font;
              if ("ams" === g) {
                var v = ft("amsrm", t.fontWeight, t.fontShape);
                return ht(
                  i,
                  v,
                  n,
              ...
              if ("main" !== g && g) {
                var y = ft(g, t.fontWeight, t.fontShape);
                return ht(i, y, n, t, a.concat(y, t.fontWeight, t.fontShape));
              }
              var b = ft("textrm", t.fontWeight, t.fontShape);
              return ht(i, b, n, t, a.concat(t.fontWeight, t.fontShape));
            }
          ...
          makeGlue: function (e, t) {
            var r = mt(["mspace"], [], t),
              n = he(e, t);
            return ((r.style.marginRight = ce(n)), r);
          },
        ...
        wt = { number: 5, unit: "mu" },
        kt = {
          mord: { mop: bt, mbin: xt, mrel: wt, minner: bt },
          mop: { mord: bt, mop: bt, mrel: wt, minner: bt },
          mbin: { mord: xt, mop: xt, mopen: xt, minner: xt },
          mrel: { mord: wt, mop: wt, mopen: wt, minner: wt },
          mopen: {},
          mclose: { mop: bt, mbin: xt, mrel: wt, minner: bt },
          mpunct: {
            mord: bt,
            mop: bt,
            mrel: wt,
        ...
        Nt = ["rightmost", "mrel", "mclose", "mpunct"],
        qt = {
          display: U.DISPLAY,
          text: U.TEXT,
          script: U.SCRIPT,
        ...
        It = function (e, t, r, n) {
          ...
          if ((yt.tryCombineChars(i), !r)) return i;
          var l = t;
          if (1 === e.length) {
            var h = e[0];
            "sizing" === h.type
              ? (l = t.havingSize(h.size))
              : "styling" === h.type && (l = t.havingStyle(qt[h.style]));
          }
          var c = Bt([n[0] || "leftmost"], [], t),
            u = Bt([n[1] || "rightmost"], [], t),
            m = "root" === r;
          return (
            Ot(
              i,
        ...
        Ot = function oi(e, t, r, n, i) {
          n && e.push(n);
          for (var a = 0; a < e.length; a++) {
            var o = e[a],
              s = Rt(o);
            if (s) oi(s.children, t, r, null, i);
            else {
              var l = !o.hasClass("mspace");
              if (l) {
                var h = t(o, r.node);
                h && (r.insertAfter ? r.insertAfter(h) : (e.unshift(h), a++));
              }
              (l
                ? (r.node = o)
                : i && o.hasClass("newline") && (r.node = Bt(["leftmost"])),
        ...
        Rt = function (e) {
          return e instanceof K ||
            e instanceof ge ||
            (e instanceof fe && e.hasClass("enclosing"))
            ? e
            : null;
        },
        Ht = function si(e, t) {
          ...
          if (r) {
            var n = r.children;
            if (n.length) {
              if ("right" === t) return si(n[n.length - 1], "right");
              if ("left" === t) return si(n[0], "left");
            }
          }
          return e;
        },
        Dt = function (e, t) {
          return e ? (t && (e = Ht(e, t)), Et[e.classes[0]] || null) : null;
        },
        Pt = function (e, t) {
          var r = ["nulldelimiter"].concat(e.baseSizingClasses());
          return Bt(t.concat(r));
        },
        Ft = function (e, t, r) {
          if (!e) return Bt();
          if (Mt[e.type]) {
          ...
          return (
            ...
            (t.toNode = function () {
              ...
              for (var t in this.attributes)
                Object.prototype.hasOwnProperty.call(this.attributes, t) &&
                  e.setAttribute(t, this.attributes[t]);
              this.classes.length > 0 && (e.className = ue(this.classes));
              for (var r = 0; r < this.children.length; r++)
                e.appendChild(this.children[r].toNode());
              return e;
            }),
            (t.toMarkup = function () {
              ...
              for (var t in this.attributes)
                Object.prototype.hasOwnProperty.call(this.attributes, t) &&
                  ...
                  (e += '"'));
              (this.classes.length > 0 &&
                (e += ' class ="' + I.escape(ue(this.classes)) + '"'),
                (e += ">"));
              for (var r = 0; r < this.children.length; r++)
                e += this.children[r].toMarkup();
              return e + "</" + this.type + ">";
        ...
        Wt = function (e, t) {
          ...
          var a = e.text;
          return I.contains(["\\imath", "\\jmath"], a)
            ? null
            : (ze[i][a] && ze[i][a].replace && (a = ze[i][a].replace),
              r(a, yt.fontMap[n].fontName, i) ? yt.fontMap[n].variant : null);
        },
        Yt = function (e, t, r) {
          if (1 === e.length) {
            var n = $t(e[0], t);
          ...
          for (var i, a = [], o = 0; o < e.length; o++) {
            var s = $t(e[o], t);
            if (s instanceof _t && i instanceof _t) {
              if (
                "mtext" === s.type &&
                "mtext" === i.type &&
                s.getAttribute("mathvariant") === i.getAttribute("mathvariant")
              ) {
                var l;
              ...
              if (
                ...
                if (
                  ...
                  d instanceof Vt &&
                    d.text.length > 0 &&
                    ((d.text = d.text.slice(0, 1) + "\u0338" + d.text.slice(1)),
                    a.pop());
                }
              }
            }
        ...
        $t = function (e, t) {
          ...
          if (zt[e.type]) return zt[e.type](e, t);
          throw new B("Got group of unknown type: '" + e.type + "'");
        },
        Kt = function (e) {
          return new ae({
        ...
        Jt = function (e, t, r) {
          var n,
            i = Kt(r);
          if ("mathml" === r.output) return c(e, t, i, r.displayMode, !0);
          if ("html" === r.output) {
            var a = l(e, i);
            n = yt.makeSpan(["katex"], [a]);
          } else {
            var o = c(e, t, i, r.displayMode, !1),
              s = l(e, i);
            n = yt.makeSpan(["katex"], [o, s]);
          }
          return Zt(n, r);
        },
        Qt = {
        ...
        tr = function (e, t, r, n, i) {
          ...
          if (/fbox|color|angl/.test(t)) {
            if (((a = yt.makeSpan(["stretchy", t], [], i)), "fbox" === t)) {
            ...
            var h = new xe(l, { width: "100%", height: ce(o) });
            a = yt.makeSvgSpan([], [h], i);
          }
          return ((a.height = o), (a.style.height = ce(o)), a);
        },
        rr = function (e) {
          var t = new Gt.MathNode("mo", [
            new Gt.TextNode(Qt[e.replace(/^\\/, "")]),
          ]);
        ...
        nr = function (e, t) {
          var r = (function () {
              var r = 4e5,
                n = e.label.slice(1);
              if (
                I.contains(["widehat", "widecheck", "widetilde", "utilde"], n)
              ) {
                var i,
                  a,
                  o,
                ...
                if (s > 5)
                  "widehat" === n || "widecheck" === n
                    ? ((i = 420), (r = 2364), (o = 0.42), (a = n + "4"))
                    : ((i = 312), (r = 2340), (o = 0.34), (a = "tilde4"));
                else {
                  var l = [1, 1, 2, 2, 3, 3][s];
                  "widehat" === n || "widecheck" === n
              ...
              for (var w = 0; w < x; w++) {
                var k = new we(g[w]),
                  S = new xe([k], {
                    ...
                    height: ce(b),
                    viewBox: "0 0 " + r + " " + y,
                    preserveAspectRatio: m[w] + " slice",
                  }),
                  A = yt.makeSvgSpan([u[w]], [S], t);
                if (1 === x) return { span: A, minWidth: v, height: b };
                ((A.style.height = ce(b)), p.push(A));
              }
              return {
                span: yt.makeSpan(["stretchy"], p, t),
                minWidth: v,
                height: b,
              };
            })(),
        ...
        ir = function (e, t) {
          ...
          e && "supsub" === e.type
            ? ((r = (i = u(e.base, "accent")).base),
              ...
              (e.base = i))
            : (r = (i = u(e, "accent")).base);
          var o = Ft(r, t.havingCrampedStyle()),
            s = 0;
          if (i.isShifty && I.isCharacterBox(r)) {
            var l = I.getBaseElem(r);
            s = n(Ft(l, t.havingCrampedStyle())).skew;
          }
          var h,
            c = "\\c" === i.label,
            m = c
              ? o.height + o.depth
              : Math.min(o.height, t.fontMetrics().xHeight);
          if (i.isStretchy)
            ((h = nr(i, t)),
              (h = yt.makeVList(
                {
            ...
            var d, p;
            ("\\vec" === i.label
              ? ((d = yt.staticSvg("vec", t)), (p = yt.svgData.vec[1]))
              : (((d = n(
                  (d = yt.makeOrd(
                    { mode: i.mode, text: i.label },
                    t,
                    "textord",
                  )),
                )).italic = 0),
                (p = d.width),
                c && (m += d.depth)),
              (h = yt.makeSpan(["accent-body"], [d])));
            var f = "\\textcircled" === i.label;
            f && (h.classes.push("accent-full"), (m = o.height));
            var g = s;
            (f || (g -= p / 2),
              (h.style.left = ce(g)),
              "\\textcircled" === i.label && (h.style.top = ".2em"),
              (h = yt.makeVList(
                {
                  positionType: "firstBaseline",
                  children: [
          ...
          var v = yt.makeSpan(["mord", "accent"], [h], t);
          return a
            ? ((a.children[0] = v),
        ...
        ar = function (e, t) {
          var r = e.isStretchy
              ? rr(e.label)
              : new Gt.MathNode("mo", [jt(e.label, e.mode)]),
            n = new Gt.MathNode("mover", [$t(e.base, t), r]);
      ...
      (a({
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            ...
            return yt.makeSpan(["mord", "accentunder"], [a], t);
          },
          mathmlBuilder: function (e, t) {
            var r = rr(e.label),
              n = new Gt.MathNode("munder", [$t(e.base, t), r]);
      ...
      a({
        ...
        htmlBuilder: function (e, t) {
          var r,
            ...
            a = yt.wrapFragment(Ft(e.body, i, t), t),
            o = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
          (a.classes.push(o + "-arrow-pad"),
            e.below &&
              ((i = t.havingStyle(n.sub())),
              (r = yt.wrapFragment(Ft(e.below, i, t), t)).classes.push(
                o + "-arrow-pad",
              )));
          var s,
            l = nr(e, t),
          ...
          if (
            ((a.depth > 0.25 || "\\xleftequilibrium" === e.label) &&
              (c -= a.depth),
            r)
          ) {
            var u =
        ...
        mathmlBuilder: function (e, t) {
          ...
          if (
            ...
            var i = sr($t(e.body, t));
            if (e.below) {
              var a = sr($t(e.below, t));
              r = new Gt.MathNode("munderover", [n, a, i]);
            } else r = new Gt.MathNode("mover", [n, i]);
          } else if (e.below) {
            var o = sr($t(e.below, t));
            r = new Gt.MathNode("munder", [n, o]);
          } else ((r = sr()), (r = new Gt.MathNode("mover", [n, r])));
          return r;
        },
      });
      var lr = yt.makeSpan;
      ...
      (a({
        ...
        handler: function (e, t) {
          return {
            ...
            mclass: hr(t[0]),
            body: Ct(t[1]),
            isCharacterBox: I.isCharacterBox(t[1]),
          };
        },
      }),
        a({
          ...
          handler: function (e, t) {
            ...
            return {
              ...
              mclass: r,
              body: [l],
              isCharacterBox: I.isCharacterBox(l),
            };
          },
          htmlBuilder: p,
          mathmlBuilder: f,
      ...
      (a({
        ...
        htmlBuilder: function (e, t) {
          var r = t.havingStyle(t.style.sup()),
            n = yt.wrapFragment(Ft(e.label, r, t), t);
          return (
            n.classes.push("cd-label-" + e.side),
            (n.style.bottom = ce(0.8 - n.depth)),
            (n.height = 0),
            (n.depth = 0),
            n
          );
        ...
        mathmlBuilder: function (e, t) {
          var r = new Gt.MathNode("mrow", [$t(e.label, t)]);
          return (
            (r = new Gt.MathNode("mpadded", [r])).setAttribute("width", "0"),
            "left" === e.side && r.setAttribute("lspace", "-1width"),
            r.setAttribute("voffset", "0.7em"),
            (r = new Gt.MathNode("mstyle", [r])).setAttribute(
              "displaystyle",
              "false",
            ),
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            var r = yt.wrapFragment(Ft(e.fragment, t), t);
            return (r.classes.push("cd-vert-arrow"), r);
          },
          mathmlBuilder: function (e, t) {
            return new Gt.MathNode("mrow", [$t(e.fragment, t)]);
          },
        }),
        a({
          type: "textord",
          ...
          handler: function (e, t) {
            for (
              var r = e.parser, n = u(t[0], "ordgroup").body, i = "", a = 0;
              a < n.length;
              a++
            )
              i += u(n[a], "textord").text;
            var o,
              s = parseInt(i);
            if (isNaN(s)) throw new B("\\@char has non-numeric argument " + i);
            if (s < 0 || s >= 1114111)
              throw new B("\\@char with invalid code point " + i);
            return (
              s <= 65535
      ...
      var mr = function (e, t) {
          ...
          return yt.makeFragment(r);
        },
        dr = function (e, t) {
          var r = Yt(e.body, t.withColor(e.color)),
            n = new Gt.MathNode("mstyle", r);
      ...
      (a({
        ...
        handler: function (e, t) {
          var r = e.parser,
            ...
            i = t[1];
          return { type: "color", mode: r.mode, color: n, body: Ct(i) };
        },
        htmlBuilder: mr,
        mathmlBuilder: dr,
      }),
        ...
        a({
          ...
          handler: function (e) {
            var t = e.parser,
              r = "[" === t.gullet.future().text ? t.parseSizeGroup(!0) : null,
              n =
                !t.settings.displayMode ||
                !t.settings.useStrictBehavior(
            ...
            return {
              ...
              mode: t.mode,
              newLine: n,
              size: r && u(r, "size").value,
            };
          },
          htmlBuilder: function (e, t) {
            var r = yt.makeSpan(["mspace"], [], t);
            return (
              e.newLine &&
                (r.classes.push("newline"),
                e.size && (r.style.marginTop = ce(he(e.size, t)))),
              r
            );
          },
          mathmlBuilder: function (e, t) {
            ...
            return (
              e.newLine &&
                ...
                e.size && r.setAttribute("height", ce(he(e.size, t)))),
              r
            );
          },
        }));
      var pr = {
        ...
        fr = function (e) {
          var t = e.text;
          if (/^(?:[\\{}$&#^_]|EOF)$/.test(t))
            throw new B("Expected a control sequence", e);
          return t;
        },
        gr = function (e, t, r, n) {
        ...
        a({
          ...
          handler: function (e) {
            var t = e.parser,
              ...
              i = n.text;
            if (/^(?:[\\{}$&#^_]|EOF)$/.test(i))
              throw new B("Expected a control sequence", n);
            for (var a, o = 0, s = [[]]; "{" !== t.gullet.future().text; )
              if ("#" === (n = t.gullet.popToken()).text) {
                if ("{" === t.gullet.future().text) {
                  ((a = t.gullet.future()), s[o].push("{"));
                  break;
                }
                if (((n = t.gullet.popToken()), !/^[1-9]$/.test(n.text)))
                  throw new B('Invalid argument number "' + n.text + '"');
                if (parseInt(n.text) !== o + 1)
                  throw new B('Argument number "' + n.text + '" out of order');
                (o++, s.push([]));
              } else {
                if ("EOF" === n.text)
            ...
            var l = t.gullet.consumeArg().tokens;
            return (
              a && l.unshift(a),
              ("\\edef" !== r && "\\xdef" !== r) ||
      ...
      var vr = function (e, t, n) {
          var i = r((ze.math[e] && ze.math[e].replace) || e, t, n);
          if (!i)
            throw new Error(
        ...
        yr = function (e, t, r, n) {
          var i = r.havingBaseStyle(t),
            a = yt.makeSpan(n.concat(i.sizingClasses(r)), [e], r),
        ...
        xr = function (e, t, r, n, i, a) {
          var o = (function (e, t, r, n) {
              return yt.makeSymbol(e, "Size" + t + "-Regular", r, n);
            })(e, t, i, n),
            s = yr(
              yt.makeSpan(["delimsizing", "size" + t], [o], n),
              U.TEXT,
              n,
              a,
            );
          return (r && br(s, n, U.TEXT), s);
        },
        wr = function (e, t, r) {
          var n;
          return (
            (n = "Size1-Regular" === t ? "delim-size1" : "delim-size4"),
            {
              ...
              elem: yt.makeSpan(
                ["delimsizinginner", n],
                [yt.makeSpan([], [yt.makeSymbol(e, t, r)])],
              ),
            }
          );
        },
        kr = function (e, t, r) {
          var n = Z["Size4-Regular"][e.charCodeAt(0)]
              ? Z["Size4-Regular"][e.charCodeAt(0)][4]
              : Z["Size1-Regular"][e.charCodeAt(0)][4],
            i = new we(
              "inner",
              (function (e, t) {
                switch (e) {
        ...
        zr = function (e, t, r, n, i, a) {
          ...
          var k = p + y + b,
            S = k + Math.max(0, Math.ceil((t - k) / (x * g))) * x * g,
          ...
          if (c.length > 0) {
            var T = S - p - y,
              ...
              O = yt.makeSvgSpan([], [E], n);
            ((O.height = C / 1e3),
              (O.style.width = N),
              (O.style.height = q),
              z.push({ type: "elem", elem: O }));
          } else {
            if ((z.push(wr(h, m, i)), z.push(Sr), null === s)) {
              var R = S - p - y + 0.016;
              z.push(kr(l, R, n));
            } else {
              var H = (S - p - y - b) / 2 + 0.016;
              (z.push(kr(l, H, n)),
                z.push(Sr),
                z.push(wr(s, m, i)),
                z.push(Sr),
            ...
            (z.push(Sr), z.push(wr(o, m, i)));
          }
          var D = n.havingBaseStyle(U.TEXT),
            P = yt.makeVList(
              { positionType: "bottom", positionData: M, children: z },
              D,
            );
          return yr(yt.makeSpan(["delimsizing", "mult"], [P], D), U.TEXT, n, a);
        },
        Tr = 0.08,
        Cr = function (e, t, r, n, i) {
          ...
          return yt.makeSvgSpan(["hide-tail"], [s], i);
        },
        Br = [
          "(",
          "\\lparen",
        ...
        qr = [0, 1.2, 1.8, 2.4, 3],
        Er = [
          { type: "small", style: U.SCRIPTSCRIPT },
          { type: "small", style: U.SCRIPT },
          { type: "small", style: U.TEXT },
          { type: "large", size: 1 },
          { type: "large", size: 2 },
          { type: "large", size: 3 },
          { type: "large", size: 4 },
        ...
        Hr = function (e, t, r, n) {
          for (
            ...
            var a = vr(e, Rr(r[i]), "math"),
              o = a.height + a.depth;
            if (
              ("small" === r[i].type &&
                (o *= n.havingBaseStyle(r[i].style).sizeMultiplier),
              o > t)
            )
              return r[i];
          }
        ...
        Dr = function (e, t, r, n, i, a) {
          ...
          ("<" === e || "\\lt" === e || "\u27e8" === e
            ? (e = "\\langle")
            : (">" !== e && "\\gt" !== e && "\u27e9" !== e) || (e = "\\rangle"),
            (o = I.contains(Nr, e) ? Er : I.contains(Br, e) ? Or : Ir));
          var s = Hr(e, t, o, n);
          return "small" === s.type
            ? (function (e, t, r, n, i, a) {
                var o = yt.makeSymbol(e, "Main-Regular", i, n),
                  s = yr(o, t, n, a);
                return (r && br(s, n, t), s);
              })(e, s.style, r, n, i, a)
            : "large" === s.type
        ...
        Pr = {
          sqrtImage: function (e, t) {
            var r,
              ...
              a = Hr("\\surd", e * i.sizeMultiplier, Or, i),
              o = i.sizeMultiplier,
              s = Math.max(
                0,
              ...
              "small" === a.type
                ...
                : "large" === a.type
                  ? ((c = 1080 * qr[a.size]),
                    (h = (qr[a.size] + s) / o),
                    (l = (qr[a.size] + s + Tr) / o),
                    ((r = Cr("sqrtSize" + a.size, l, c, s, t)).style.minWidth =
                      "1.02em"),
                    (n = 1 / o))
                  : ((l = e + s + Tr),
                    (h = e + s),
                    (c = Math.floor(1e3 * e + s) + 80),
                    ((r = Cr("sqrtTall", l, c, s, t)).style.minWidth =
                      "0.742em"),
                    (n = 1.056)),
              (r.height = h),
              (r.style.height = ce(l)),
          ...
          sizedDelim: function (e, t, r, n, i) {
            if (
              ("<" === e || "\\lt" === e || "\u27e8" === e
                ? (e = "\\langle")
                : (">" !== e && "\\gt" !== e && "\u27e9" !== e) ||
                  (e = "\\rangle"),
              I.contains(Br, e) || I.contains(Nr, e))
            )
              return xr(e, t, !1, r, n, i);
            if (I.contains(Lr, e)) return zr(e, qr[t], !1, r, n, i);
            throw new B("Illegal delimiter: '" + e + "'");
          },
          sizeToMaxHeight: qr,
          customSizedDelim: Dr,
          leftRightDelim: function (e, t, r, n, i, a) {
            var o = n.fontMetrics().axisHeight * n.sizeMultiplier,
              s = 5 / n.fontMetrics().ptPerEm,
              l = Math.max(t - o, r + o),
              h = Math.max((l / 500) * 901, 2 * l - s);
            return Dr(e, h, !0, n, i, a);
          },
        },
        Fr = {
      ...
      (a({
        ...
        handler: function (e, t) {
          ...
          return {
            type: "delimsizing",
            mode: e.parser.mode,
            size: Fr[e.funcName].size,
            mclass: Fr[e.funcName].mclass,
            delim: r.text,
          };
        },
        htmlBuilder: function (e, t) {
          return "." === e.delim
            ? yt.makeSpan([e.mclass])
            : Pr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]);
        },
        mathmlBuilder: function (e) {
          var t = [];
          "." !== e.delim && t.push(jt(e.delim, e.mode));
          var r = new Gt.MathNode("mo", t);
          ("mopen" === e.mclass || "mclose" === e.mclass
            ? r.setAttribute("fence", "true")
            : r.setAttribute("fence", "false"),
            r.setAttribute("stretchy", "true"));
          var n = ce(Pr.sizeToMaxHeight[e.size]);
          return (
            r.setAttribute("minsize", n),
        ...
        a({
          ...
          handler: function (e, t) {
            ...
            var a = u(n.parseFunction(), "leftright-right");
            return {
              type: "leftright",
              mode: n.mode,
              body: i,
          ...
          htmlBuilder: function (e, t) {
            ...
            if (
              ...
              (r =
                "." === e.left
                  ? Pt(t, ["mopen"])
                  : Pr.leftRightDelim(e.left, a, o, t, e.mode, ["mopen"])),
              i.unshift(r),
              s)
            )
            ...
            if ("." === e.right) n = Pt(t, ["mclose"]);
            else {
              var u = e.rightColor ? t.withColor(e.rightColor) : t;
              n = Pr.leftRightDelim(e.right, a, o, u, e.mode, ["mclose"]);
            }
            return (i.push(n), yt.makeSpan(["minner"], i, t));
          },
          mathmlBuilder: function (e, t) {
            y(e);
            var r = Yt(e.body, t);
            if ("." !== e.left) {
              var n = new Gt.MathNode("mo", [jt(e.left, e.mode)]);
              (n.setAttribute("fence", "true"), r.unshift(n));
            }
            if ("." !== e.right) {
              var i = new Gt.MathNode("mo", [jt(e.right, e.mode)]);
        ...
        a({
          ...
          handler: function (e, t) {
            ...
            if (!e.parser.leftrightDepth)
              throw new B("\\middle without preceding \\left", r);
      ...
      var Vr = function (e, t) {
          var r,
            n,
            i,
            a = yt.wrapFragment(Ft(e.body, t), t),
            o = e.label.slice(1),
            s = t.sizeMultiplier,
            l = 0,
            h = I.isCharacterBox(e.body);
          if ("sout" === o)
            (((r = yt.makeSpan(["stretchy", "sout"])).height =
              t.fontMetrics().defaultRuleThickness / s),
              (l = -0.5 * t.fontMetrics().xHeight));
          else if ("phase" === o) {
            var c = he({ number: 0.6, unit: "pt" }, t),
              u = he({ number: 0.35, unit: "ex" }, t);
            s /= t.havingBaseSizing().sizeMultiplier;
            var m = a.height + a.depth + c + u;
            a.style.paddingLeft = ce(m / 2 + c);
            var d = Math.floor(1e3 * m * s),
              p =
                "M400000 " +
                (n = d) +
                " H0 L" +
                ...
                (n - 80) +
                " H400000z",
              f = new xe([new we("phase", p)], {
                width: "400em",
                height: ce(d / 1e3),
                viewBox: "0 0 400000 " + d,
                preserveAspectRatio: "xMinYMin slice",
              });
            (((r = yt.makeSvgSpan(["hide-tail"], [f], t)).style.height = ce(m)),
              (l = a.depth + c + u));
          } else {
            /cancel/.test(o)
            ...
            (/box/.test(o)
              ? ((y = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness)),
                (v = g = t.fontMetrics().fboxsep + ("colorbox" === o ? 0 : y)))
              : "angl" === o
                ? ((g =
                    4 *
                    (y = Math.max(
                  ...
                  (v = Math.max(0, 0.25 - a.depth)))
                : (v = g = h ? 0.2 : 0),
              (r = tr(a, o, g, v, t)),
              /fbox|boxed|fcolorbox/.test(o)
                ? ((r.style.borderStyle = "solid"),
                  (r.style.borderWidth = ce(y)))
                : "angl" === o &&
                  0.049 !== y &&
                  ((r.style.borderTopWidth = ce(y)),
                  (r.style.borderRightWidth = ce(y))),
              (l = a.depth + v),
              e.backgroundColor &&
          ...
          if (e.backgroundColor)
            ...
            var b = /cancel|phase/.test(o) ? ["svg-align"] : [];
            i = yt.makeVList(
              {
                positionType: "individualShift",
                children: [
                  { type: "elem", elem: a, shift: 0 },
                  { type: "elem", elem: r, shift: l, wrapperClasses: b },
                ],
              },
              t,
            );
          ...
          return (
            /cancel/.test(o) && ((i.height = a.height), (i.depth = a.depth)),
            /cancel/.test(o) && !h
              ? yt.makeSpan(["mord", "cancel-lap"], [i], t)
              : yt.makeSpan(["mord"], [i], t)
          );
        },
        Gr = function (e, t) {
          var r = 0,
      ...
      var jr = {},
        ...
        Yr = (function () {
          ...
          return (
            (e.prototype.range = function (t, r) {
              return new e(r, Wr.range(this, t));
            }),
            e
          );
        })(),
        ...
        $r = function (e, t) {
          ...
          e.colSeparationType &&
            ...
            (m =
              (t.havingStyle(U.SCRIPT).sizeMultiplier / t.sizeMultiplier) *
              0.2778);
          var d =
              "CD" === e.colSeparationType
                ? he({ number: 3, unit: "ex" }, t)
                : 12 * u,
            p = 3 * u,
            f = e.arraystretch * d,
            g = 0.7 * f,
            v = 0.3 * f,
            y = 0;
          for (r(o[0]), n = 0; n < e.body.length; ++n) {
            var b = e.body[n],
              x = g,
              w = v;
          ...
          var z,
            T,
            C = y / 2 + t.fontMetrics().axisHeight,
            L = e.cols || [],
            N = [],
            q = [];
          if (
            ...
            for (n = 0; n < a; ++n) {
              ...
              (((H =
                !0 === R
                  ? yt.makeSpan(["eqn-num"], [], t)
                  : !1 === R
                    ? yt.makeSpan([], [], t)
                    : yt.makeSpan([], It(R, t, !0), t)).depth = E.depth),
                (H.height = E.height),
                q.push({ type: "elem", elem: H, shift: O }));
            }
          for (i = 0, T = 0; i < s || T < L.length; ++i, ++T) {
            for (var D = L[T] || {}, P = !0; "separator" === D.type; ) {
              if (
                (P ||
                  (((z = yt.makeSpan(["arraycolsep"], [])).style.width = ce(
                    t.fontMetrics().doubleRuleSep,
                  )),
                  N.push(z)),
                "|" !== D.separator && ":" !== D.separator)
              )
                throw new B("Invalid separator type: " + D.separator);
              var F = "|" === D.separator ? "solid" : "dashed",
                _ = yt.makeSpan(["vertical-separator"], [], t);
              ((_.style.height = ce(y)),
                (_.style.borderRightWidth = ce(c)),
                (_.style.borderRightStyle = F),
                (_.style.margin = "0 " + ce(-c / 2)));
              var V = y - C;
              (V && (_.style.verticalAlign = ce(-V)),
                N.push(_),
                (D = L[++T] || {}),
                (P = !1));
            }
            if (!(i >= s)) {
              ...
              (i > 0 || e.hskipBeforeAndAfter) &&
                0 !== (G = I.deflt(D.pregap, m)) &&
                (((z = yt.makeSpan(["arraycolsep"], [])).style.width = ce(G)),
                N.push(z));
              var j = [];
              for (n = 0; n < a; ++n) {
                var W = l[n],
                ...
                if (Y) {
                  ...
                  ((Y.depth = W.depth),
                    (Y.height = W.height),
                    j.push({ type: "elem", elem: Y, shift: X }));
                }
              }
              ((j = yt.makeVList(
                ...
                (j = yt.makeSpan(["col-align-" + (D.align || "c")], [j])),
                N.push(j),
                (i < s - 1 || e.hskipBeforeAndAfter) &&
                  0 !== (G = I.deflt(D.postgap, m)) &&
                  (((z = yt.makeSpan(["arraycolsep"], [])).style.width = ce(G)),
                  N.push(z)));
            }
          }
          if (((l = yt.makeSpan(["mtable"], N)), h.length > 0)) {
            for (
              var $ = yt.makeLineSpan("hline", t, c),
                K = yt.makeLineSpan("hdashline", t, c),
                Z = [{ type: "elem", elem: l, shift: 0 }];
              h.length > 0;
              ...
              var J = h.pop(),
                Q = J.pos - C;
              J.isDashed
                ? Z.push({ type: "elem", elem: K, shift: Q })
                : Z.push({ type: "elem", elem: $, shift: Q });
            }
            l = yt.makeVList(
          ...
          if (0 === q.length) return yt.makeSpan(["mord"], [l], t);
          var ee = yt.makeVList(
            { positionType: "individualShift", children: q },
            t,
          );
          return (
            (ee = yt.makeSpan(["tag"], [ee], t)),
            yt.makeFragment([l, ee])
          );
        },
        Kr = { c: "center ", l: "left ", r: "right " },
        Zr = function (e, t) {
          for (
            var r = [],
              n = new Gt.MathNode("mtd", [], ["mtr-glue"]),
              i = new Gt.MathNode("mtd", [], ["mml-eqn-num"]),
              a = 0;
            a < e.body.length;
            a++
          ) {
            for (var o = e.body[a], s = [], l = 0; l < o.length; l++)
              s.push(new Gt.MathNode("mtd", [$t(o[l], t)]));
            (e.tags &&
              e.tags[a] &&
              (s.unshift(n), s.push(n), e.leqno ? s.unshift(i) : s.push(i)),
              r.push(new Gt.MathNode("mtr", s)));
          }
          ...
          h.setAttribute("rowspacing", ce(c));
          var u = "",
            m = "";
          if (e.cols && e.cols.length > 0) {
            var d = e.cols,
              ...
              g = 0,
              v = d.length;
            ("separator" === d[0].type && ((u += "top "), (g = 1)),
              "separator" === d[d.length - 1].type &&
                ((u += "bottom "), (v -= 1)));
            for (var y = g; y < v; y++)
              "align" === d[y].type
                ? ((m += Kr[d[y].align]), f && (p += "none "), (f = !0))
                : "separator" === d[y].type &&
                  f &&
                  ((p += "|" === d[y].separator ? "solid " : "dashed "),
                  (f = !1));
            (h.setAttribute("columnalign", m.trim()),
              /[sd]/.test(p) && h.setAttribute("columnlines", p.trim()));
          }
          ...
          var k = "",
            S = e.hLinesBeforeRow;
          ((u += S[0].length > 0 ? "left " : ""),
            (u += S[S.length - 1].length > 0 ? "right " : ""));
          for (var A = 1; A < S.length - 1; A++)
            k += 0 === S[A].length ? "none " : S[A][0] ? "dashed " : "solid ";
          return (
            /[sd]/.test(k) && h.setAttribute("rowlines", k.trim()),
            "" !== u &&
              (h = new Gt.MathNode("menclose", [h])).setAttribute(
                "notation",
                u.trim(),
              ),
            e.arraystretch &&
              e.arraystretch < 1 &&
              (h = new Gt.MathNode("mstyle", [h])).setAttribute(
                "scriptlevel",
                "1",
              ),
            h
        ...
        Jr = function (e, t) {
          ...
          if (t[0] && "ordgroup" === t[0].type) {
            for (var h = "", c = 0; c < t[0].body.length; c++)
              h += u(t[0].body[c], "textord").text;
            ((r = Number(h)), (s = 2 * r));
          }
          var m = !s;
          o.body.forEach(function (e) {
            for (var t = 1; t < e.length; t += 2) {
              u(u(e[t], "styling").body[0], "ordgroup").body.unshift(l);
            }
          ...
          for (var d = 0; d < s; ++d) {
            var p = "r",
              f = 0;
            (d % 2 == 1 ? (p = "l") : d > 0 && m && (f = 1),
              (n[d] = { type: "align", align: p, pregap: f, postgap: 0 }));
          }
      ...
      (b({
        ...
        props: { numArgs: 1 },
        handler: function (e, t) {
          var r = (d(t[0]) ? [t[0]] : u(t[0], "ordgroup").body).map(
              function (e) {
                var t = m(e).text;
            ...
            n = { cols: r, hskipBeforeAndAfter: !0, maxNumCols: r.length };
          return S(e.parser, n, A(e.envName));
        },
        htmlBuilder: $r,
        mathmlBuilder: Zr,
      }),
        b({
          ...
          handler: function (e) {
            ...
            var a = S(e.parser, n, A(e.envName)),
              o = Math.max.apply(
                Math,
                [0].concat(
                  a.body.map(function (e) {
                    return e.length;
                  }),
                ),
              );
            return (
              (a.cols = new Array(o).fill({ type: "align", align: r })),
              t
                ? {
                    type: "leftright",
                    mode: e.mode,
        ...
        b({
          ...
          props: { numArgs: 0 },
          handler: function (e) {
            var t = S(e.parser, { arraystretch: 0.5 }, "script");
        ...
        b({
          ...
          handler: function (e, t) {
            ...
            if (
              (n = S(e.parser, n, "script")).body.length > 0 &&
              n.body[0].length > 1
            )
              throw new B("{subarray} can contain only one column");
            return n;
        ...
        b({
          ...
          props: { numArgs: 0 },
          handler: function (e) {
            I.contains(["gather", "gather*"], e.envName) && Xr(e);
            var t = {
              ...
              (function (e) {
                ...
                for (
                  ...
                  if ("&" !== r && "\\\\" !== r) {
                    ...
                    throw new B("Expected \\\\ or \\cr or \\end", e.nextToken);
                  }
                  e.consume();
                }
                for (var n, i, a = [], o = [a], s = 0; s < t.length; s++) {
                  for (
                    var l = t[s],
                      h = {
                        type: "styling",
                    ...
                    if (ur(l[c])) {
                      ...
                      if (
                        ...
                        for (var p = 0; p < 2; p++) {
                          for (var f = !0, v = c + 1; v < l.length; v++) {
                            if (
                              ((i = u),
                              ("mathord" === (n = l[v]).type ||
                                "atom" === n.type) &&
                    ...
                    } else h.body.push(l[c]);
                  (s % 2 == 0 ? a.push(h) : a.shift(), (a = []), o.push(a));
                }
                return (
                  e.gullet.endGroup(),
                  e.gullet.endGroup(),
      ...
      a({
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = e.funcName,
            i = t[0];
          if ("ordgroup" !== i.type) throw new B("Invalid environment name", i);
          for (var a = "", o = 0; o < i.body.length; ++o)
            a += u(i.body[o], "textord").text;
          if ("\\begin" === n) {
            if (!Qr.hasOwnProperty(a))
              throw new B("No such environment: " + a, i);
            var s = Qr[a],
              l = r.parseArguments("\\begin{" + a + "}", s),
              h = l.args,
              c = l.optArgs,
              m = { mode: r.mode, envName: a, parser: r },
              d = s.handler(m, h, c);
            r.expect("\\end", !1);
            var p = r.nextToken,
              f = u(r.parseFunction(), "environment");
            if (f.name !== a)
              throw new B(
                "Mismatch: \\begin{" + a + "} matched by \\end{" + f.name + "}",
                p,
              );
            return d;
          }
        ...
        a({
          ...
          handler: function (e) {
            var t = e.parser,
              ...
              n = e.breakOnTokenText,
              i = t.mode,
              a = t.parseExpression(!0, n);
            return {
              type: "font",
              mode: i,
              font: "math" + r.slice(1),
              body: { type: "ordgroup", mode: t.mode, body: a },
            };
          },
          htmlBuilder: en,
          mathmlBuilder: tn,
      ...
      var nn = function (e, t) {
          ...
          return (
            "display" === e
              ? (r = r.id >= U.SCRIPT.id ? r.text() : U.DISPLAY)
              : "text" === e && r.size === U.DISPLAY.size
                ? (r = U.TEXT)
                : "script" === e
                  ? (r = U.SCRIPT)
                  : "scriptscript" === e && (r = U.SCRIPTSCRIPT),
            r
          );
        },
        an = function (e, t) {
          ...
          if (
            (e.hasBarLine
              ? (e.barSize
                  ? ((c = he(e.barSize, t)),
                    (h = yt.makeLineSpan("frac-line", t, c)))
                  : (h = yt.makeLineSpan("frac-line", t)),
                (c = h.height),
                (u = h.height))
              : ((h = null),
                (c = 0),
                (u = t.fontMetrics().defaultRuleThickness)),
            n.size === U.DISPLAY.size || "display" === e.size
              ? ((m = t.fontMetrics().num1),
                (d = c > 0 ? 3 * u : 7 * u),
                (p = t.fontMetrics().denom1))
              : (c > 0
                  ? ((m = t.fontMetrics().num2), (d = u))
                  : ((m = t.fontMetrics().num3), (d = 3 * u)),
                (p = t.fontMetrics().denom2)),
            h)
          ) {
            var x = t.fontMetrics().axisHeight;
            (m - o.depth - (x + 0.5 * c) < d &&
              (m += d - (m - o.depth - (x + 0.5 * c))),
              x - 0.5 * c - (b.height - p) < d &&
                (p += d - (x - 0.5 * c - (b.height - p))));
            var w = -(x - 0.5 * c);
            f = yt.makeVList(
              {
                positionType: "individualShift",
                children: [
                  { type: "elem", elem: b, shift: p },
            ...
            var k = m - o.depth - (b.height - p);
            (k < d && ((m += 0.5 * (d - k)), (p += 0.5 * (d - k))),
              (f = yt.makeVList(
                {
                  positionType: "individualShift",
                  children: [
          ...
          return (
            ...
            (g =
              n.size === U.DISPLAY.size
                ? t.fontMetrics().delim1
                : n.size === U.SCRIPTSCRIPT.size
                  ? t.havingStyle(U.SCRIPT).fontMetrics().delim2
            ...
            yt.makeSpan(
              ...
              [v, yt.makeSpan(["mfrac"], [f]), y],
              t,
            )
          );
        },
        on = function (e, t) {
          var r = new Gt.MathNode("mfrac", [$t(e.numer, t), $t(e.denom, t)]);
          if (e.hasBarLine) {
            if (e.barSize) {
              var n = he(e.barSize, t);
              r.setAttribute("linethickness", ce(n));
            }
          } else r.setAttribute("linethickness", "0px");
          var i = nn(e.size, t.style);
          if (i.size !== t.style.size) {
            r = new Gt.MathNode("mstyle", [r]);
            var a = i.size === U.DISPLAY.size ? "true" : "false";
            (r.setAttribute("displaystyle", a),
              r.setAttribute("scriptlevel", "0"));
          }
          if (null != e.leftDelim || null != e.rightDelim) {
            var o = [];
            if (null != e.leftDelim) {
              var s = new Gt.MathNode("mo", [
                new Gt.TextNode(e.leftDelim.replace("\\", "")),
              ]);
              (s.setAttribute("fence", "true"), o.push(s));
            }
            if ((o.push(r), null != e.rightDelim)) {
              var l = new Gt.MathNode("mo", [
                new Gt.TextNode(e.rightDelim.replace("\\", "")),
              ]);
      ...
      (a({
        ...
        a({
          ...
          handler: function (e) {
            ...
            return { type: "infix", mode: r.mode, replaceWith: t, token: i };
          },
        }));
      var sn = ["display", "text", "script", "scriptscript"],
        ln = function (e) {
          var t = null;
      ...
      (a({
        ...
        handler: function (e, t) {
          var r,
            ...
            a = t[5],
            o = Tt(t[0]),
            s = "atom" === o.type && "open" === o.family ? ln(o.text) : null,
            l = Tt(t[1]),
            h = "atom" === l.type && "close" === l.family ? ln(l.text) : null,
            c = u(t[2], "size"),
            m = null;
          ...
          if ("ordgroup" === p.type) {
            if (p.body.length > 0) {
              var f = u(p.body[0], "textord");
              d = sn[Number(f.text)];
            }
          } else ((p = u(p, "textord")), (d = sn[Number(p.text)]));
          return {
            type: "genfrac",
            mode: n.mode,
            numer: i,
      ...
      var hn = function (e, t) {
        ...
        "supsub" === e.type
          ? ((r = e.sup
              ? Ft(e.sup, t.havingStyle(i.sup()), t)
              : Ft(e.sub, t.havingStyle(i.sub()), t)),
            (n = u(e.base, "horizBrace")))
          : (n = u(e, "horizBrace"));
        var a,
          o = Ft(n.base, t.havingBaseStyle(U.DISPLAY)),
          s = nr(n, t);
        if (
          (n.isOver
            ? (a = yt.makeVList(
          ...
          var l = yt.makeSpan(["mord", n.isOver ? "mover" : "munder"], [a], t);
          a = n.isOver
            ? yt.makeVList(
                {
                  positionType: "firstBaseline",
        ...
        return yt.makeSpan(["mord", n.isOver ? "mover" : "munder"], [a], t);
      };
      (a({
        type: "horizBrace",
        ...
        mathmlBuilder: function (e, t) {
          var r = rr(e.label);
          return new Gt.MathNode(e.isOver ? "mover" : "munder", [
            $t(e.base, t),
            r,
          ]);
        },
        ...
        a({
          ...
          handler: function (e, t) {
            ...
            return r.settings.isTrusted({ command: "\\href", url: i })
              ? { type: "href", mode: r.mode, href: i, body: Ct(n) }
              : r.formatUnsupportedCmd("\\href");
          },
          htmlBuilder: function (e, t) {
            var r = It(e.body, t, !1);
            return yt.makeAnchor(e.href, [], r, t);
          },
          mathmlBuilder: function (e, t) {
            var r = Xt(e.body, t);
            return (
              r instanceof _t || (r = new _t("mrow", [r])),
        ...
        a({
          ...
          handler: function (e, t) {
            ...
            var s = { type: "text", mode: r.mode, font: "\\texttt", body: i };
            return { type: "href", mode: r.mode, href: n, body: Ct(s) };
          },
        }),
        a({
          type: "hbox",
          ...
          handler: function (e, t) {
            return { type: "hbox", mode: e.parser.mode, body: Ct(t[0]) };
          },
          htmlBuilder: function (e, t) {
            var r = It(e.body, t, !1);
            return yt.makeFragment(r);
          ...
          mathmlBuilder: function (e, t) {
            return new Gt.MathNode("mrow", Yt(e.body, t));
          },
        }),
        a({
          type: "html",
          ...
          handler: function (e, t) {
            ...
            switch (i) {
              case "\\htmlClass":
                ((s["class"] = a), (r = { command: "\\htmlClass", class: a }));
                break;
              case "\\htmlId":
                ((s.id = a), (r = { command: "\\htmlId", id: a }));
                break;
              case "\\htmlStyle":
                ((s.style = a), (r = { command: "\\htmlStyle", style: a }));
                break;
              case "\\htmlData":
                for (var l = a.split(","), h = 0; h < l.length; h++) {
                  var c = l[h].split("=");
                  if (2 !== c.length)
                    throw new B("Error parsing key-value for \\htmlData");
                  s["data-" + c[0].trim()] = c[1].trim();
                }
                r = { command: "\\htmlData", attributes: s };
                break;
              default:
                throw new Error("Unrecognized html command");
            }
            return n.settings.isTrusted(r)
              ? { type: "html", mode: n.mode, attributes: s, body: Ct(o) }
      ...
      (a({
        ...
        handler: function (e, t, r) {
          ...
          if (r[0])
            for (
              var l = u(r[0], "raw").string.split(","), h = 0;
              h < l.length;
              h++
            ) {
              var c = l[h].split("=");
        ...
        htmlBuilder: function (e, t) {
          var r = he(e.height, t),
            n = 0;
          e.totalheight.number > 0 && (n = he(e.totalheight, t) - r);
          var i = 0;
          e.width.number > 0 && (i = he(e.width, t));
          var a = { height: ce(r + n) };
          (i > 0 && (a.width = ce(i)), n > 0 && (a.verticalAlign = ce(-n)));
        ...
        mathmlBuilder: function (e, t) {
          ...
          if (
            (e.totalheight.number > 0 &&
              ((i = he(e.totalheight, t) - n),
              r.setAttribute("valign", ce(-i))),
            r.setAttribute("height", ce(n + i)),
            e.width.number > 0)
          ) {
            var a = he(e.width, t);
            r.setAttribute("width", ce(a));
          }
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            return yt.makeGlue(e.dimension, t);
          },
          mathmlBuilder: function (e, t) {
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            var r;
            "clap" === e.alignment
              ? ((r = yt.makeSpan([], [Ft(e.body, t)])),
                (r = yt.makeSpan(["inner"], [r], t)))
              : (r = yt.makeSpan(["inner"], [Ft(e.body, t)]));
            var n = yt.makeSpan(["fix"], []),
              i = yt.makeSpan([e.alignment], [r, n], t),
              a = yt.makeSpan(["strut"]);
            return (
              (a.style.height = ce(i.height + i.depth)),
              i.depth && (a.style.verticalAlign = ce(-i.depth)),
              i.children.unshift(a),
              (i = yt.makeSpan(["thinbox"], [i], t)),
              yt.makeSpan(["mord", "vbox"], [i], t)
            );
          },
          mathmlBuilder: function (e, t) {
            var r = new Gt.MathNode("mpadded", [$t(e.body, t)]);
            if ("rlap" !== e.alignment) {
        ...
        a({
          ...
          handler: function (e) {
            ...
            return (
              r.expect(i),
              r.switchMode(n),
              { type: "styling", mode: r.mode, style: "text", body: a }
            );
          },
        }),
        a({
          ...
          props: { numArgs: 0, allowedInText: !0, allowedInMath: !1 },
          handler: function (e) {
            throw new B("Mismatched " + e.funcName);
          },
        }));
      var un = function (e, t) {
        switch (t.style.size) {
      ...
      var mn = function (e, t, r, n, i, a, o) {
          e = yt.makeSpan([], [e]);
          var s,
            l,
            h,
            c = r && I.isCharacterBox(r);
          if (t) {
            var u = Ft(t, n.havingStyle(i.sup()), n);
            l = {
              elem: u,
              kern: Math.max(
          ...
          if (r) {
            var m = Ft(r, n.havingStyle(i.sub()), n);
            s = {
              elem: m,
              kern: Math.max(
                n.fontMetrics().bigOpSpacing2,
                n.fontMetrics().bigOpSpacing4 - m.height,
              ),
            };
          }
          if (l && s) {
            ...
            h = yt.makeVList(
              {
                ...
                children: [
                  ...
                  { type: "elem", elem: s.elem, marginLeft: ce(-a) },
          ...
          var g = [h];
          if (s && 0 !== a && !c) {
            var v = yt.makeSpan(["mspace"], [], n);
            ((v.style.marginRight = ce(a)), g.unshift(v));
          }
          return yt.makeSpan(["mop", "op-limits"], g, n);
        },
        dn = ["\\smallint"],
        pn = function (e, t) {
          var r,
            ...
            a = !1;
          "supsub" === e.type
            ? ((r = e.sup), (n = e.sub), (i = u(e.base, "op")), (a = !0))
            : (i = u(e, "op"));
          var o,
            s = t.style,
            l = !1;
          if (
            (s.size === U.DISPLAY.size &&
              i.symbol &&
              !I.contains(dn, i.name) &&
              (l = !0),
            i.symbol)
          ) {
            ...
            if (
              ...
              (o = yt.makeSymbol(i.name, h, "math", t, [
                "mop",
                "op-symbol",
                l ? "large-op" : "small-op",
              ])),
            ...
            var p = It(i.body, t, !0);
            1 === p.length && p[0] instanceof be
              ? ((o = p[0]).classes[0] = "mop")
              : (o = yt.makeSpan(["mop"], p, t));
          } else {
            for (var f = [], g = 1; g < i.name.length; g++)
              f.push(yt.mathsym(i.name[g], i.mode, t));
            o = yt.makeSpan(["mop"], f, t);
          }
          var v = 0,
            y = 0;
          return (
            ...
            a
              ? mn(o, r, n, t, s, y, v)
              : (v && ((o.style.position = "relative"), (o.style.top = ce(v))),
                o)
          );
        },
        fn = function (e, t) {
          var r;
          if (e.symbol)
            ((r = new _t("mo", [jt(e.name, e.mode)])),
              I.contains(dn, e.name) && r.setAttribute("largeop", "false"));
          else if (e.body) r = new _t("mo", Yt(e.body, t));
          else {
            r = new _t("mi", [new Vt(e.name.slice(1))]);
            var n = new _t("mo", [jt("\u2061", "text")]);
            r = e.parentIsSupSub ? new _t("mrow", [r, n]) : h([r, n]);
          }
          return r;
        },
        gn = {
      ...
      var yn = function (e, t) {
        ...
        if (
          ("supsub" === e.type
            ? ((r = e.sup),
              (n = e.sub),
              (i = u(e.base, "operatorname")),
              (o = !0))
            : (i = u(e, "operatorname")),
          i.body.length > 0)
        ) {
          for (
            var s = i.body.map(function (e) {
                var t = e.text;
                return "string" == typeof t
                  ? { type: "textord", mode: e.mode, text: t }
                  : e;
              }),
              l = It(s, t.withFont("mathrm"), !0),
              h = 0;
            h < l.length;
            h++
          ) {
          ...
          a = yt.makeSpan(["mop"], l, t);
        } else a = yt.makeSpan(["mop"], [], t);
        return o ? mn(a, r, n, t, t.style, 0, 0) : a;
      };
      (a({
        type: "operatorname",
        ...
        mathmlBuilder: function (e, t) {
          for (
            var r = Yt(e.body, t.withFont("mathrm")), n = !0, i = 0;
            i < r.length;
            i++
          ) {
            var a = r[i];
            if (a instanceof Gt.SpaceNode);
            else if (a instanceof Gt.MathNode)
              switch (a.type) {
                case "mi":
                case "mn":
                case "ms":
                ...
                case "mo":
                  var o = a.children[0];
                  1 === a.children.length && o instanceof Gt.TextNode
                    ? (o.text = o.text
                        .replace(/\u2212/, "-")
                        .replace(/\u2217/, "*"))
                    : (n = !1);
          ...
          var h = new Gt.MathNode("mo", [jt("\u2061", "text")]);
          return e.parentIsSupSub
            ? new Gt.MathNode("mrow", [l, h])
            : Gt.newDocumentFragment([l, h]);
        },
      }),
        ...
        o({
          ...
          htmlBuilder: function (e, t) {
            return e.semisimple
              ? yt.makeFragment(It(e.body, t, !1))
              : yt.makeSpan(["mord"], It(e.body, t, !0), t);
          },
          mathmlBuilder: function (e, t) {
            return Xt(e.body, t, !0);
          },
        }),
        a({
          type: "overline",
          ...
          htmlBuilder: function (e, t) {
            var r = Ft(e.body, t.havingCrampedStyle()),
              n = yt.makeLineSpan("overline-line", t),
            ...
            return yt.makeSpan(["mord", "overline"], [a], t);
          },
          mathmlBuilder: function (e, t) {
            var r = new Gt.MathNode("mo", [new Gt.TextNode("\u203e")]);
            r.setAttribute("stretchy", "true");
            var n = new Gt.MathNode("mover", [$t(e.body, t), r]);
            return (n.setAttribute("accent", "true"), n);
          },
        }),
        a({
          ...
          handler: function (e, t) {
            var r = e.parser,
              n = t[0];
            return { type: "phantom", mode: r.mode, body: Ct(n) };
          },
          htmlBuilder: function (e, t) {
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            var r = yt.makeSpan([], [Ft(e.body, t.withPhantom())]);
            ...
            return (
              ...
              yt.makeSpan(["mord"], [r], t)
            );
          },
          mathmlBuilder: function (e, t) {
            var r = Yt(Ct(e.body), t),
              n = new Gt.MathNode("mphantom", r),
              i = new Gt.MathNode("mpadded", [n]);
            return (
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            var r = yt.makeSpan(["inner"], [Ft(e.body, t.withPhantom())]),
              n = yt.makeSpan(["fix"], []);
            return yt.makeSpan(["mord", "rlap"], [r, n], t);
          },
          mathmlBuilder: function (e, t) {
            var r = Yt(Ct(e.body), t),
              n = new Gt.MathNode("mphantom", r),
        ...
        a({
          ...
          handler: function (e, t, r) {
            ...
            return {
              type: "rule",
              mode: n.mode,
              shift: i && u(i, "size").value,
              width: a.value,
              height: o.value,
            };
          },
          htmlBuilder: function (e, t) {
            var r = yt.makeSpan(["mord", "rule"], [], t),
              n = he(e.width, t),
              i = he(e.height, t),
              a = e.shift ? he(e.shift, t) : 0;
            return (
              (r.style.borderRightWidth = ce(n)),
              (r.style.borderTopWidth = ce(i)),
              (r.style.bottom = ce(a)),
              (r.width = n),
              (r.height = i + a),
              (r.depth = -a),
          ...
          mathmlBuilder: function (e, t) {
            ...
            (o.setAttribute("mathbackground", a),
              o.setAttribute("width", ce(r)),
              o.setAttribute("height", ce(n)));
            var s = new Gt.MathNode("mpadded", [o]);
            return (
              i >= 0
                ? s.setAttribute("height", ce(i))
                : (s.setAttribute("height", ce(i)),
                  s.setAttribute("depth", ce(-i))),
              s.setAttribute("voffset", ce(i)),
              s
            );
          },
        }));
      ...
      (a({
        ...
        mathmlBuilder: function (e, t) {
          var r = t.havingSize(e.size),
            n = Yt(e.body, r),
            i = new Gt.MathNode("mstyle", n);
          return (i.setAttribute("mathsize", ce(r.sizeMultiplier)), i);
        },
      }),
        a({
          type: "smash",
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            ...
            (0 === r.height && (r.height = t.fontMetrics().xHeight),
              (r = yt.wrapFragment(r, t)));
            var n = t.fontMetrics().defaultRuleThickness,
              i = n;
            t.style.id < U.TEXT.id && (i = t.fontMetrics().xHeight);
            var a = n + i / 4,
              ...
              c = s.advanceWidth,
              u = l.height - h;
            u > r.height + r.depth + a &&
              (a = (a + u - r.height - r.depth) / 2);
            var m = l.height - r.height - a - h;
            r.style.paddingLeft = ce(c);
            var d = yt.makeVList(
              {
                positionType: "firstBaseline",
                children: [
            ...
            if (e.index) {
              var p = t.havingStyle(U.SCRIPTSCRIPT),
                f = Ft(e.index, p, t),
                ...
                y = yt.makeSpan(["root"], [v]);
              return yt.makeSpan(["mord", "sqrt"], [y, d], t);
            }
            return yt.makeSpan(["mord", "sqrt"], [d], t);
          },
          mathmlBuilder: function (e, t) {
            var r = e.body,
              n = e.index;
            return n
              ? new Gt.MathNode("mroot", [$t(r, t), $t(n, t)])
              : new Gt.MathNode("msqrt", [$t(r, t)]);
          },
        }));
      var xn = {
        display: U.DISPLAY,
      ...
      var wn = function (e, t) {
        ...
        return r
          ? "op" === r.type
            ? r.limits &&
              (t.style.size === U.DISPLAY.size || r.alwaysHandleSupSub)
              ? pn
              : null
            : "operatorname" === r.type
              ? r.alwaysHandleSupSub &&
                (t.style.size === U.DISPLAY.size || r.limits)
                ? yn
                : null
              : "accent" === r.type
                ? I.isCharacterBox(r.base)
                  ? ir
                  : null
      ...
      (o({
        ...
        htmlBuilder: function (e, t) {
          ...
          a =
            t.style === U.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
          var g,
            v = t.sizeMultiplier,
            y = ce(0.5 / c.ptPerEm / v),
            b = null;
          if (i) {
            var x =
              e.base &&
            ...
            (h instanceof be || x) && (b = ce(-h.italic));
          }
          if (n && i) {
            ((u = Math.max(u, a, n.depth + 0.25 * c.xHeight)),
              (m = Math.max(m, c.sub2)));
            var w = 4 * c.defaultRuleThickness;
            if (u - n.depth - (i.height - m) < w) {
              m = w - (u - n.depth) + i.height;
              var k = 0.8 * c.xHeight - (u - n.depth);
              k > 0 && ((u += k), (m -= k));
            }
            var S = [
              {
            ...
            m = Math.max(m, c.sub1, i.height - 0.8 * c.xHeight);
            var A = [{ type: "elem", elem: i, marginLeft: b, marginRight: y }];
            g = yt.makeVList(
              { positionType: "shift", positionData: m, children: A },
              t,
            );
          } else {
          ...
          var M = Dt(h, "right") || "mord";
          return yt.makeSpan([M], [h, yt.makeSpan(["msupsub"], [g])], t);
        },
        mathmlBuilder: function (e, t) {
          var r,
            n = !1;
          ...
          var i,
            a = [$t(e.base, t)];
          if ((e.sub && a.push($t(e.sub, t)), e.sup && a.push($t(e.sup, t)), n))
            i = r ? "mover" : "munder";
          else if (e.sub)
            if (e.sup) {
              var o = e.base;
              i =
                (o && "op" === o.type && o.limits && t.style === U.DISPLAY) ||
                (o &&
                  "operatorname" === o.type &&
                  o.alwaysHandleSupSub &&
                  (t.style === U.DISPLAY || o.limits))
                  ? "munderover"
                  : "msubsup";
            } else {
              var s = e.base;
              i =
                (s &&
                  "op" === s.type &&
                  s.limits &&
                  (t.style === U.DISPLAY || s.alwaysHandleSupSub)) ||
                (s &&
                  "operatorname" === s.type &&
            ...
            i =
              (l &&
                "op" === l.type &&
                l.limits &&
                (t.style === U.DISPLAY || l.alwaysHandleSupSub)) ||
              (l &&
                "operatorname" === l.type &&
                l.alwaysHandleSupSub &&
                (l.limits || t.style === U.DISPLAY))
                ? "mover"
                : "msup";
          }
          return new Gt.MathNode(i, a);
        },
      }),
        o({
          type: "atom",
          htmlBuilder: function (e, t) {
            return yt.mathsym(e.text, e.mode, t, ["m" + e.family]);
          },
          mathmlBuilder: function (e, t) {
            var r = new Gt.MathNode("mo", [jt(e.text, e.mode)]);
            if ("bin" === e.family) {
              var n = Wt(e, t);
      ...
      (o({
        type: "mathord",
        htmlBuilder: function (e, t) {
          return yt.makeOrd(e, t, "mathord");
        },
        mathmlBuilder: function (e, t) {
          var r = new Gt.MathNode("mi", [jt(e.text, e.mode, t)]),
            n = Wt(e, t) || "italic";
        ...
        o({
          type: "textord",
          htmlBuilder: function (e, t) {
            return yt.makeOrd(e, t, "textord");
          },
          mathmlBuilder: function (e, t) {
            var r,
              n = jt(e.text, e.mode, t),
              i = Wt(e, t) || "normal";
            return (
              (r =
                "text" === e.mode
                  ? new Gt.MathNode("mtext", [n])
                  : /[0-9]/.test(e.text)
                    ? new Gt.MathNode("mn", [n])
                    : "\\prime" === e.text
                      ? new Gt.MathNode("mo", [n])
                      : new Gt.MathNode("mi", [n])),
              i !== kn[r.type] && r.setAttribute("mathvariant", i),
              r
            );
          },
        }));
      ...
      o({
        ...
        htmlBuilder: function (e, t) {
          if (An.hasOwnProperty(e.text)) {
            ...
            if ("text" === e.mode) {
              var n = yt.makeOrd(e, t, "textord");
              return (n.classes.push(r), n);
            }
            return yt.makeSpan(
              ["mspace", r],
              [yt.mathsym(e.text, e.mode, t)],
              t,
            );
          }
          if (Sn.hasOwnProperty(e.text))
            return yt.makeSpan(["mspace", Sn[e.text]], [], t);
          throw new B('Unknown type of space "' + e.text + '"');
        },
        mathmlBuilder: function (e) {
          if (!An.hasOwnProperty(e.text)) {
            if (Sn.hasOwnProperty(e.text)) return new Gt.MathNode("mspace");
            throw new B('Unknown type of space "' + e.text + '"');
          }
          return new Gt.MathNode("mtext", [new Gt.TextNode("\xa0")]);
        },
      });
      var Mn = function () {
      ...
      o({
        type: "tag",
        mathmlBuilder: function (e, t) {
          var r = new Gt.MathNode("mtable", [
            new Gt.MathNode("mtr", [
              Mn(),
              new Gt.MathNode("mtd", [Xt(e.body, t)]),
              Mn(),
              new Gt.MathNode("mtd", [Xt(e.tag, t)]),
            ]),
          ]);
      ...
      var zn = {
        ...
        Cn = { "\\textit": "textit", "\\textup": "textup" },
        Bn = function (e, t) {
          var r = e.font;
          return r
            ? zn[r]
              ? t.withTextFontFamily(zn[r])
              : Tn[r]
                ? t.withTextFontWeight(Tn[r])
                : t.withTextFontShape(Cn[r])
            : t;
        };
      (a({
        type: "text",
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = e.funcName,
            i = t[0];
          return { type: "text", mode: r.mode, body: Ct(i), font: n };
        },
        htmlBuilder: function (e, t) {
          var r = Bn(e, t),
            n = It(e.body, r, !0);
          return yt.makeSpan(["mord", "text"], n, r);
        },
        mathmlBuilder: function (e, t) {
          var r = Bn(e, t);
          return Xt(e.body, r);
        ...
        a({
          ...
          htmlBuilder: function (e, t) {
            var r = Ft(e.body, t),
              n = yt.makeLineSpan("underline-line", t),
              i = t.fontMetrics().defaultRuleThickness,
              a = yt.makeVList(
                {
                  positionType: "top",
            ...
            return yt.makeSpan(["mord", "underline"], [a], t);
          },
          mathmlBuilder: function (e, t) {
            var r = new Gt.MathNode("mo", [new Gt.TextNode("\u203e")]);
            r.setAttribute("stretchy", "true");
            var n = new Gt.MathNode("munder", [$t(e.body, t), r]);
            return (n.setAttribute("accentunder", "true"), n);
          },
        }),
        a({
          ...
          mathmlBuilder: function (e, t) {
            return new Gt.MathNode("mpadded", [$t(e.body, t)], ["vcenter"]);
          },
        }),
        a({
          type: "verb",
          ...
          htmlBuilder: function (e, t) {
            for (
              var r = Ln(e), n = [], i = t.havingStyle(t.style.text()), a = 0;
              a < r.length;
              a++
            ) {
              var o = r[a];
              ("~" === o && (o = "\\textasciitilde"),
                n.push(
                  yt.makeSymbol(o, "Typewriter-Regular", e.mode, i, [
                    "mord",
                    "texttt",
                  ]),
                ));
            ...
            return yt.makeSpan(
              ...
              yt.tryCombineChars(n),
              i,
            );
          },
          mathmlBuilder: function (e) {
            var t = new Gt.TextNode(Ln(e)),
              r = new Gt.MathNode("mtext", [t]);
        ...
        Hn = (function () {
          function e(e, t) {
            ((this.input = void 0),
              ...
              (this.input = e),
              (this.settings = t),
              (this.tokenRegex = new RegExp(Rn, "g")),
              (this.catcodes = { "%": 14, "~": 13 }));
          }
          var t = e.prototype;
          return (
            ...
            (t.lex = function () {
              ...
              if (t === e.length) return new Yr("EOF", new Wr(this, t, t));
              var r = this.tokenRegex.exec(e);
              if (null === r || r.index !== t)
                throw new B(
                  "Unexpected character: '" + e[t] + "'",
                  new Yr(e[t], new Wr(this, t, t + 1)),
                );
              var n = r[6] || r[3] || (r[2] ? "\\ " : " ");
              ...
              return new Yr(n, new Wr(this, t, this.tokenRegex.lastIndex));
            }),
            e
          );
        })(),
      ...
      x("\\char", function (e) {
        ...
        if ("'" === r.text) ((t = 8), (r = e.popToken()));
          ...
          if ("\\" === (r = e.popToken()).text[0]) n = r.text.charCodeAt(1);
            ...
            if ("EOF" === r.text) throw new B("\\char` missing argument");
            n = r.text.charCodeAt(0);
          }
        else t = 10;
        if (t) {
          if (null == (n = Fn[r.text]) || n >= t)
            throw new B("Invalid base-" + t + " digit " + r.text);
          for (var i; null != (i = Fn[e.future().text]) && i < t; )
            ((n *= t), (n += i), e.popToken());
        }
        return "\\@char{" + n + "}";
      });
      var _n = function (e, t, r) {
        ...
        if (1 === (n = e.consumeArg().tokens).length && "[" === n[0].text) {
          ...
          if (!s.match(/^\s*[0-9]+\s*$/))
            throw new B("Invalid number of arguments: " + s);
          ((o = parseInt(s)), (n = e.consumeArg().tokens));
        }
      ...
      (x("\\newcommand", function (e) {
        ...
        x("\\renewcommand", function (e) {
          return _n(e, !0, !1);
        }),
        x("\\providecommand", function (e) {
          return _n(e, !0, !0);
        }),
        x("\\message", function (e) {
        ...
        x("\\show", function (e) {
          var t = e.popToken(),
            r = t.text;
          return (
            console.log(t, e.macros.get(r), Nn[r], ze.math[r], ze.text[r]),
            ""
          );
        }),
        x("\\bgroup", "{"),
        ...
        x("\\aa", "\\r a"),
        x("\\AA", "\\r A"),
        x("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`\xa9}"),
        x(
          "\\copyright",
        ...
        x("\\vdots", "\\mathord{\\varvdots\\rule{0pt}{15pt}}"),
        x("\u22ee", "\\vdots"),
      ...
      x("\\dots", function (e) {
        ...
        return (
          r in Vn
            ...
            : ("\\not" === r.slice(0, 4) ||
                (r in ze.math &&
                  I.contains(["bin", "rel"], ze.math[r].group))) &&
              (t = "\\dotsb"),
          t
        );
      });
      ...
      var jn = ce(
        Z["Main-Regular"]["T".charCodeAt(0)][1] -
          0.7 * Z["Main-Regular"]["A".charCodeAt(0)][1],
      );
      (x(
        "\\LaTeX",
      ...
      var Un = function (e) {
        return function (t) {
          ...
          var l = function (t) {
            return function (r) {
              e && (r.macros.set("|", o), i.length && r.macros.set("\\|", s));
              var a = t;
              return (
                !t &&
                  i.length &&
        ...
        Yn = (function () {
          function e(e, t, r) {
            ((this.settings = void 0),
              ...
              this.feed(e),
              (this.macros = new Dn(Pn, t.macros)),
              (this.mode = r),
              (this.stack = []));
          }
          var t = e.prototype;
          return (
            (t.feed = function (e) {
              this.lexer = new Hn(e, this.settings);
            }),
            ...
            (t.expandOnce = function (e) {
              ...
              if (null == n || (e && n.unexpandable)) {
                if (e && null == n && "\\" === r[0] && !this.isDefined(r))
              ...
              var i = n.tokens,
                a = this.consumeArgs(n.numArgs, n.delimiters);
              if (n.numArgs)
                for (var o = (i = i.slice()).length - 1; o >= 0; --o) {
                  ...
                  if ("#" === s.text) {
                    ...
                    if ("#" === (s = i[--o]).text) i.splice(o + 1, 1);
                    else {
                      if (!/^[1-9]$/.test(s.text))
                        throw new B("Not a valid argument number", s);
                      var l;
                      (l = i).splice.apply(l, [o, 2].concat(a[+s.text - 1]));
                    }
                  }
                }
              ...
              if ("string" == typeof n) {
                ...
                if (-1 !== n.indexOf("#"))
                  for (
                    ...
                    ++i;
                for (
                  var o = new Hn(n, this.settings), s = [], l = o.lex();
                  "EOF" !== l.text;
            ...
            (t.isDefined = function (e) {
              return (
                this.macros.has(e) ||
                Nn.hasOwnProperty(e) ||
                ze.math.hasOwnProperty(e) ||
                ze.text.hasOwnProperty(e) ||
                Wn.hasOwnProperty(e)
              );
            }),
        ...
        Jn = (function () {
          function e(e, t) {
            ((this.mode = void 0),
              ...
              (this.mode = "math"),
              (this.gullet = new Yn(e, t, this.mode)),
              (this.settings = t),
          ...
          return (
            ...
            (r.parseExpression = function (t, r) {
              for (var n = []; ; ) {
                "math" === this.mode && this.consumeSpaces();
                var i = this.fetch();
                if (-1 !== e.endOfExpression.indexOf(i.text)) break;
                if (r && i.text === r) break;
                if (t && Nn[i.text] && Nn[i.text].infix) break;
                var a = this.parseAtom(r);
                if (!a) break;
                "internal" !== a.type && n.push(a);
              }
              return (
            ...
            (r.handleInfixNodes = function (e) {
              ...
              if (-1 !== r && t) {
                ...
                return (
                  ...
                  [
                    "\\\\abovefrac" === t
                      ? this.callFunction(t, [i, e[r], a], [])
                      : this.callFunction(t, [i, a], []),
                  ]
                );
              }
              return e;
            }),
            (r.handleSupSubscript = function (e) {
              var t = this.fetch(),
                r = t.text;
              (this.consume(), this.consumeSpaces());
              var n = this.parseGroup(e);
              if (!n) throw new B("Expected group after '" + r + "'", t);
              return n;
            }),
            (r.formatUnsupportedCmd = function (e) {
            ...
            (r.parseAtom = function (t) {
              ...
              for (;;) {
                ...
                if ("\\limits" === a.text || "\\nolimits" === a.text) {
                  if (i && "op" === i.type) {
                    var o = "\\limits" === a.text;
                    ((i.limits = o), (i.alwaysHandleSupSub = !0));
                  } else {
                    ...
                    i.alwaysHandleSupSub && (i.limits = "\\limits" === a.text);
                  }
                  this.consume();
                } else if ("^" === a.text) {
                  if (r) throw new B("Double superscript", a);
                  r = this.handleSupSubscript("superscript");
                } else if ("_" === a.text) {
                  if (n) throw new B("Double subscript", a);
                  ...
                  for (this.consume(); ; ) {
                    ...
                    if (!$n[u]) break;
                    if (Xn.test(u) !== c) break;
                    (this.consume(), (h += $n[u]));
                  }
                  var m = new e(h, this.settings).parse();
                  c
                    ? (n = { type: "ordgroup", mode: "math", body: m })
                    : (r = { type: "ordgroup", mode: "math", body: m });
                }
              }
              return r || n
                ? { type: "supsub", mode: this.mode, base: i, sup: r, sub: n }
                : i;
            }),
            (r.parseFunction = function (e, t) {
              var r = this.fetch(),
                n = r.text,
                i = Nn[n];
              if (!i) return null;
              ...
              var a = this.parseArguments(n, i),
                o = a.args,
                s = a.optArgs;
              return this.callFunction(n, o, s, r, e);
            }),
            (r.callFunction = function (e, t, r, n, i) {
              var a = {
                  funcName: e,
                  parser: this,
                  token: n,
            ...
            (r.parseGroupOfType = function (e, t, r) {
              switch (t) {
                case "color":
                ...
                case "raw":
                  ...
                  return null != i
                    ...
                    : null;
                case "primitive":
                  if (r) throw new B("A primitive argument cannot be optional");
            ...
            (r.consumeSpaces = function () {
              for (; " " === this.fetch().text; ) this.consume();
            }),
            (r.parseStringGroup = function (e, t) {
              var r = this.gullet.scanArgument(t);
              if (null == r) return null;
              for (var n, i = ""; "EOF" !== (n = this.fetch()).text; )
                ((i += n.text), this.consume());
              return (this.consume(), (r.text = i), r);
            }),
            (r.parseRegexGroup = function (e, t) {
              for (
                var r, n = this.fetch(), i = n, a = "";
                "EOF" !== (r = this.fetch()).text && e.test(a + r.text);

              )
                ((a += (i = r).text), this.consume());
              if ("" === a)
                throw new B("Invalid " + t + ": '" + n.text + "'", n);
              return n.range(i, a);
            }),
            (r.parseColorGroup = function (e) {
              var t = this.parseStringGroup("color", e);
              if (null == t) return null;
              var r = /^(#[a-f0-9]{3}|#?[a-f0-9]{6}|[a-z]+)$/i.exec(t.text);
              if (!r) throw new B("Invalid color: '" + t.text + "'", t);
              var n = r[0];
              return (
            ...
            (r.parseSizeGroup = function (e) {
              ...
              if (!n) throw new B("Invalid size: '" + t.text + "'", t);
              var i = { number: +(n[1] + n[2]), unit: n[3] };
              if (!le(i)) throw new B("Invalid unit: '" + i.unit + "'", t);
              return { type: "size", mode: this.mode, value: i, isBlank: r };
            }),
            (r.parseUrlGroup = function (e) {
            ...
            (r.parseArgumentGroup = function (e, t) {
            ...
            (r.parseGroup = function (e, t) {
              ...
              if ("{" === i || "\\begingroup" === i) {
                ...
                if (this.settings.throwOnError)
                  throw new B("Undefined control sequence: " + i, n);
                ((r = this.formatUnsupportedCmd(i)), this.consume());
              }
              return r;
            }),
            (r.formLigatures = function (e) {
            ...
            (r.parseSymbol = function () {
              ...
              if (
                ...
                } else s = { type: l, mode: this.mode, loc: h, text: r };
                a = s;
              } else {
              ...
              if ((this.consume(), o))
                for (var u = 0; u < o[0].length; u++) {
                  var m = o[0][u];
                  if (!Kn[m]) throw new B("Unknown accent ' " + m + "'", e);
                  var d = Kn[m][this.mode] || Kn[m].text;
                  if (!d)
                    throw new B(
                      "Accent " + m + " unsupported in " + this.mode + " mode",
                      e,
                    );
                  a = {
                    type: "accent",
      ...
      var ti = function (e, t, r) {
          if (r.throwOnError || !(e instanceof B)) throw e;
          var n = yt.makeSpan(["katex-error"], [new be(t)]);
          return (
        ...
        ni = {
          ...
          __renderToDomTree: ri,
          __renderToHTMLTree: function (e, t) {
            var r = new R(t);
            try {
              return (function (e, t, r) {
                var n = l(e, Kt(r)),
                  i = yt.makeSpan(["katex"], [n]);
                return Zt(i, r);
              })(Qn(e, r), 0, r);
            } catch (t) {
              return ti(t, e, r);
          ...
          var e = t(771),
            ...
            o = function (e, t) {
              for (
                ...
                r > 0 &&
                  (i.push({ type: "text", data: e.slice(0, r) }),
                  (e = e.slice(r)));
                var s = t.findIndex(function (t) {
                  return e.startsWith(t.left);
                });
                if (-1 === (r = n(t[s].right, e, t[s].left.length))) break;
                var l = e.slice(0, r + t[s].right.length),
                  h = a.test(l) ? l : e.slice(t[s].left.length, r);
                (i.push({
                  type: "math",
                  data: h,
                  rawData: l,
              ...
              for (
                ...
                if ("text" === n[a].type)
                  ...
                  var s = document.createElement("span"),
                    l = n[a].data;
                  t.displayMode = n[a].display;
                  try {
                    (t.preProcess && (l = t.preProcess(l)),
                      r().render(l, s, t));
                  } catch (e) {
                    if (!(e instanceof r().ParseError)) throw e;
                    (t.errorCallback(
            ...
            l = function c(e, t) {
              for (var r = 0; r < e.childNodes.length; r++) {
                ...
                if (3 === n.nodeType) {
                  for (
                    var i = n.textContent, a = n.nextSibling, o = 0;
                    a && a.nodeType === Node.TEXT_NODE;

                  )
                    ((i += a.textContent), (a = a.nextSibling), o++);
                  var l = s(i, t);
                  if (l) {
                    for (var h = 0; h < o; h++) n.nextSibling.remove();
                    ((r += l.childNodes.length - 1), e.replaceChild(l, n));
                  } else r += o;
                } else
                  1 === n.nodeType &&
                    (function () {
                      var e = " " + n.className + " ";
                      -1 === t.ignoredTags.indexOf(n.nodeName.toLowerCase()) &&
                        t.ignoredClasses.every(function (t) {
                          return -1 === e.indexOf(" " + t + " ");
                        }) &&
                        c(n, t);
                    })();
  ...
  (function (e, t) {
    ...
    function a(e, t) {
      ((this.J = e), (this.t = t || e), (this.C = this.t.document));
    }
    function o(e, r, n) {
      ((e = e.C.getElementsByTagName(r)[0]) || (e = t.documentElement),
        e && e.lastChild && e.insertBefore(n, e.lastChild));
    }
    function s(e, t) {
      function r() {
        e.C.body ? t() : setTimeout(r, 0);
      }
      r();
    }
    function l(e, t, r) {
    ...
    function c(e) {
      if ("string" == typeof e.ma) return e.ma;
      var t = e.t.location.protocol;
      return (
        "about:" == t && (t = e.J.location.protocol),
        "https:" == t ? "https:" : "http:"
      );
    }
    function u(e, t) {
      var r = e.createElement("link", { rel: "stylesheet", href: t }),
        n = !1;
      ((r.onload = function () {
        n || (n = !0);
      }),
    ...
    function m(t, r, n, i) {
      ...
      if (a) {
        var o = t.createElement("script", { src: r }),
          s = !1;
        return (
    ...
    function f(e) {
      ...
      return (
        (e = Z.exec(e)) &&
          (null !== e[1] && e[1] && (t = parseInt(e[1], 10)),
          null !== e[2] && e[2] && (r = parseInt(e[2], 10)),
          null !== e[3] && e[3] && (n = parseInt(e[3], 10)),
          null !== e[4] &&
            e[4] &&
            (i = /^[0-9]+$/.test(e[4]) ? parseInt(e[4], 10) : e[4])),
        new p(t, r, n, i)
      );
    }
    ...
    function y(e) {
      ...
      return "" != t
        ...
        : "" !=
          ...
          ? ("Mac_PowerPC" == e
              ? (e = "Macintosh")
              : "PlayStation" == e && (e = "Linux"),
            e)
          : "Unknown";
    }
    function b(e) {
      if (
        (t = w(e.a, /(OS X|Windows NT|Android) ([^;)]+)/, 2)) ||
        (t = w(e.a, /Windows Phone( OS)? ([^;)]+)/, 2)) ||
        (t = w(e.a, /(iPhone )?OS ([\d_]+)/, 2))
      )
        return t;
      if ((t = w(e.a, /(?:Linux|CrOS|CrKey) ([^;)]+)/, 1)))
        for (var t = t.split(/\s/), r = 0; r < t.length; r += 1)
          if (/^[\d\._]+$/.test(t[r])) return t[r];
      return (e = w(e.a, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2))
        ? e
        : "Unknown";
    }
    function x(e) {
          ...
          : -1 != e.a.indexOf("Chrome") ||
            ...
            : /Silk\/\d/.test(e.a)
              ...
              : "BlackBerry" == t || "Android" == t
                ? (i = "BuiltinBrowser")
                : -1 != e.a.indexOf("PhantomJS")
                  ? (i = "PhantomJS")
                  : -1 != e.a.indexOf("Safari")
                    ? (i = "Safari")
                    : -1 != e.a.indexOf("AdobeAIR")
                      ? (i = "AdobeAIR")
                      : -1 != e.a.indexOf("PlayStation") &&
                        (i = "BuiltinBrowser"),
        "BuiltinBrowser" == i
          ? (a = "Unknown")
          : "Silk" == i
            ? (a = w(e.a, /Silk\/([\d\._]+)/, 1))
            : "Chrome" == i
              ? (a = w(e.a, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2))
              : -1 != e.a.indexOf("Version/")
                ? (a = w(e.a, /Version\/([\d\.\w]+)/, 1))
                : "AdobeAIR" == i
                  ? (a = w(e.a, /AdobeAIR\/([\d\.]+)/, 1))
                  : "Opera" == i
                    ? (a = w(e.a, /OPR\/([\d.]+)/, 1))
                    : "PhantomJS" == i &&
                      (a = w(e.a, /PhantomJS\/([\d.]+)/, 1)),
        (a = f(a)),
        new g(
          i,
          0,
          ...
          new d(
            "AdobeAIR" == i
              ...
              : "BlackBerry" == t
                ...
                : "Android" == t
                  ? 2 < r.c || (2 == r.c && 1 < r.g)
                  : 526 <= n.c || (525 <= n.c && 13 <= n.g),
            536 > n.c || (536 == n.c && 11 > n.g),
          ),
        )
      );
    }
    function w(e, t, r) {
      return (e = e.match(t)) && e[r] ? e[r] : "";
    }
    function k(e) {
      this.la = e || "-";
    }
    function S(e, t) {
      ((this.M = e), (this.Y = 4), (this.N = "n"));
      ...
      return (
        e &&
          ...
          (n = e.match(/([1-9]00|normal|bold)/i)) &&
            ...
            (/bold/i.test(n[1])
              ? (t = 7)
              : /[1-9]00/.test(n[1]) && (t = parseInt(n[1].substr(0, 1), 10)))),
        r + t
      );
    }
    function z(e, t) {
      ((this.d = e),
        (this.p = e.t.document.documentElement),
        (this.P = t),
        (this.j = "wf"),
        (this.h = new k("-")),
        (this.ga = !1 !== t.events),
    ...
    function T(e) {
      if (e.B) {
        var t = h(e.p, e.h.e(e.j, "active")),
          r = [],
          n = [e.h.e(e.j, "loading")];
        (t || r.push(e.h.e(e.j, "inactive")), l(e.p, r, n));
      }
      C(e, "inactive");
    }
    function C(e, t, r) {
      e.ga && e.P[t] && (r ? e.P[t](r.getName(), A(r)) : e.P[t]());
    }
    function B() {
      this.w = {};
    }
    ...
    function q(e) {
      var t;
      t = [];
      for (var r = e.M.split(/,\s*/), n = 0; n < r.length; n++) {
        var i = r[n].replace(/['"]/g, "");
      ...
      return (
        (t = t.join(",")),
        (r = "normal"),
        "o" === e.N ? (r = "oblique") : "i" === e.N && (r = "italic"),
    ...
    function E(e, t, r, n, i, a, o, s) {
      ...
      (this.ba = o || null),
      (this.F = this.D = null),
      N((e = new L(this.d, this.G))),
      Q))
        Q.hasOwnProperty(l) &&
          ((t = q((t = new S(Q[l], A(this.s))))),
          (e.m.style.cssText = t),
          (this.I[Q[l]] = e.m.offsetWidth));
      e.remove();
    }
    function I(e, t, r) {
      for (var n in Q)
        if (Q.hasOwnProperty(n) && t === e.I[Q[n]] && r === e.I[Q[n]])
          return !0;
      return !1;
    }
    function O(e) {
      var t = e.D.m.offsetWidth,
        r = e.F.m.offsetWidth;
      (t === e.I.serif && r === e.I["sans-serif"]) || (e.k.fa && I(e, t, r))
        ? K() - e.na >= e.W
          ? e.k.fa &&
            I(e, t, r) &&
            (null === e.ba || e.ba.hasOwnProperty(e.s.getName()))
            ? H(e, e.Z)
            : H(e, e.ja)
          : R(e)
        : H(e, e.Z);
    ...
    function P(e, t, r, n, a) {
      if (((r = r || {}), 0 === t.length && a)) T(e.u);
      else
        for (e.R += t.length, a && (e.aa = a), a = 0; a < t.length; a++) {
          var o = t[a],
            s = r[o.getName()],
            h = e.u,
            c = o;
          (h.B && l(h.p, [h.h.e(h.j, c.getName(), A(c).toString(), "loading")]),
            C(h, "fontloading", c),
            (h = null),
            (h = new E(
              i(e.ha, e),
        ...
        (e.da
          ? ((e = e.u).B &&
              l(
                e.p,
                [e.h.e(e.j, "active")],
                [e.h.e(e.j, "loading"), e.h.e(e.j, "inactive")],
              ),
            C(e, "active"))
          : T(e.u));
    }
    function _(e) {
      ((this.J = e),
        (this.v = new B()),
        (this.oa = new v(e.navigator.userAgent)),
    ...
    a.prototype.createElement = function (e, t, r) {
      if (((e = this.C.createElement(e)), t))
        for (var n in t)
          t.hasOwnProperty(n) &&
            ("style" == n ? (e.style.cssText = t[n]) : e.setAttribute(n, t[n]));
      return (r && e.appendChild(this.C.createTextNode(r)), e);
    };
    var Z = /^([0-9]+)(?:[\._-]([0-9]+))?(?:[\._-]([0-9]+))?(?:[\._+-]?(.*))?$/;
    ((p.prototype.compare = function (e) {
      return this.c > e.c ||
        (this.c === e.c && this.g > e.g) ||
        (this.c === e.c && this.g === e.g && this.A > e.A)
        ? 1
        : this.c < e.c ||
            (this.c === e.c && this.g < e.g) ||
            (this.c === e.c && this.g === e.g && this.A < e.A)
      ...
      if (-1 != this.a.indexOf("MSIE") || -1 != this.a.indexOf("Trident/")) {
        ...
        ("" != n && f(n),
          (e = new g(
            ...
            new d(
              ("Windows" == e && 6 <= r.c) ||
                ("Windows Phone" == e && 8 <= t.c),
              !1,
            ),
          )));
      } else if (-1 != this.a.indexOf("Opera"))
        e: if (
          ((e = f(w(this.a, /Presto\/([\d\w\.]+)/, 1))),
          f(b(this)),
          null !== e.c || f(w(this.a, /rv:([^\)]+)/, 1)),
          -1 != this.a.indexOf("Opera Mini/"))
        )
          ((e = f(w(this.a, /Opera Mini\/([\d\.]+)/, 1))),
            (e = new g("OperaMini", 0, 0, 0, y(this), 0, 0, new d(!1, !1))));
        else {
          if (
            -1 != this.a.indexOf("Version/") &&
            null !== (e = f(w(this.a, /Version\/([\d\.]+)/, 1))).c
          ) {
            e = new g("Opera", 0, 0, 0, y(this), 0, 0, new d(10 <= e.c, !1));
            break e;
          }
          e =
            null !== (e = f(w(this.a, /Opera[\/ ]([\d\.]+)/, 1))).c
              ? new g("Opera", 0, 0, 0, y(this), 0, 0, new d(10 <= e.c, !1))
              : new g("Opera", 0, 0, 0, y(this), 0, 0, new d(!1, !1));
        }
      else
        /OPR\/[\d.]+/.test(this.a)
          ? (e = x(this))
            ...
            : -1 != this.a.indexOf("Gecko")
              ? ((e = "Unknown"),
                ...
                -1 != this.a.indexOf("Firefox")
                  ? ((e = "Firefox"),
                    (t =
                      3 <= (t = f(w(this.a, /Firefox\/([\d\w\.]+)/, 1))).c &&
                      5 <= t.g))
                  : -1 != this.a.indexOf("Mozilla") && (e = "Mozilla"),
                (r = f(w(this.a, /rv:([^\)]+)/, 1))),
                t ||
                  (t =
                    1 < r.c ||
                    (1 == r.c && 9 < r.g) ||
                    (1 == r.c && 9 == r.g && 2 <= r.A)),
                (e = new g(e, 0, 0, 0, y(this), 0, 0, new d(t, !1))))
              : (e = J);
      return e;
    }),
    ...
    ((E.prototype.start = function () {
      ((this.D = new L(this.d, this.G)),
        ...
        N(this.F),
        (this.na = K()));
      var e = q((e = new S(this.s.getName() + ",serif", A(this.s))));
      ((this.D.m.style.cssText = e),
        (e = q((e = new S(this.s.getName() + ",sans-serif", A(this.s))))),
        (this.F.m.style.cssText = e),
        O(this));
    }),
      (D.prototype.ha = function (e) {
        var t = this.u;
        (t.B &&
          l(
            t.p,
            [t.h.e(t.j, e.getName(), A(e).toString(), "active")],
            [
              t.h.e(t.j, e.getName(), A(e).toString(), "loading"),
              t.h.e(t.j, e.getName(), A(e).toString(), "inactive"),
            ],
          ),
          C(t, "fontactive", e),
          (this.da = !0),
      ...
      (D.prototype.ia = function (e) {
        var t = this.u;
        if (t.B) {
          var r = h(t.p, t.h.e(t.j, e.getName(), A(e).toString(), "active")),
            n = [],
            i = [t.h.e(t.j, e.getName(), A(e).toString(), "loading")];
          (r || n.push(t.h.e(t.j, e.getName(), A(e).toString(), "inactive")),
            l(t.p, n, i));
        }
        (C(t, "fontinactive", e), F(this));
      }),
      (_.prototype.load = function (e) {
        ((this.d = new a(this.J, e.context || this.J)),
          (this.S = !1 !== e.events),
          (this.Q = !1 !== e.classes));
        var t = new z(this.d, e),
          r = [],
          n = e.timeout;
        (t.B && l(t.p, [t.h.e(t.j, "loading")]), C(t, "loading"));
        r = this.v;
        var o,
          s = this.d,
          h = [];
        ...
        for (
          r = h,
            this.T = this.U = r.length,
            e = new D(this.a, this.d, t, n),
            n = 0,
            o = r.length;
          n < o;
          n++
        )
          (s = r[n]).K(this.a, i(this.ka, this, s, t, e));
      }),
      (_.prototype.ka = function (e, t, r, n) {
        var i = this;
        n
          ...
          : ((e = 0 == --this.U),
            ...
            e && 0 == this.T
              ? T(t)
              : (this.Q || this.S) && P(r, [], {}, null, e));
      }));
    var ee = "//fonts.googleapis.com/css";
    G.prototype.e = function () {
      if (0 == this.q.length) throw Error("No fonts to load!");
      if (-1 != this.O.indexOf("kit=")) return this.O;
      for (var e = this.q.length, t = [], r = 0; r < e; r++)
        t.push(this.q[r].replace(/ /g, "+"));
      return (
        (e = this.O + "?family=" + t.join("%7C")),
        0 < this.V.length && (e += "&subset=" + this.V.join(",")),
        0 < this.ea.length && (e += "&text=" + encodeURIComponent(this.ea)),
        e
      );
    };
    var te = {
      ...
      ne = { i: "i", italic: "i", n: "n", normal: "n" },
      ie =
        /^(thin|(?:(?:extra|ultra)-?)?light|regular|book|medium|(?:(?:semi|demi|extra|ultra)-?)?bold|black|heavy|l|r|b|[1-9]00)?(n|i|normal|italic)?$/;
    j.prototype.parse = function () {
      for (var e = this.q.length, t = 0; t < e; t++) {
        var r = this.q[t].split(":"),
          n = r[0].replace(/\+/g, " "),
          i = ["n4"];
        if (2 <= r.length) {
          var a;
          if (((a = []), (o = r[1])))
            for (var o, s = (o = o.split(",")).length, l = 0; l < s; l++) {
              var h;
              if ((h = o[l]).match(/^[\w-]+$/)) {
                var c = void 0;
                if (null == (h = ie.exec(h.toLowerCase()))) c = "";
                else {
                  if (((c = void 0), null == (c = h[1]) || "" == c)) c = "4";
                  else {
                    var u = re[c];
                    c = u || (isNaN(c) ? "4" : c.substr(0, 1));
                  }
                  c = [null == (h = h[2]) || "" == h ? "n" : ne[h], c].join("");
                }
                h = c;
              } else h = "";
              h && a.push(h);
        ...
        for (
          this.L[n] || ((r = te[n]) && (this.L[n] = r)), r = 0;
          r < i.length;
          r += 1
        )
          this.ca.push(new S(n, i[r]));
      }
    };
    ...
    ((U.prototype.K = function (e, t) {
      ...
      (U.prototype.$ = function (e) {
        for (
          var t = this.d,
            r = new G(this.f.api, c(t), this.f.text),
            n = this.f.families,
            i = n.length,
            a = 0;
          a < i;
        ...
        ((n = new j(n)).parse(), u(t, r.e()), e(n.ca, n.L, ae));
      }),
      (W.prototype.H = function (e) {
        ...
        return (
          ...
          (t.t.location.hostname || t.J.location.hostname) +
          "/" +
          e +
          ".js"
        );
      }),
      (W.prototype.K = function (e, t) {
        var r = this.f.id,
          n = this.d.t,
          i = this;
        r
          ? (n.__webfontfontdeckmodule__ || (n.__webfontfontdeckmodule__ = {}),
            (n.__webfontfontdeckmodule__[r] = function (e, r) {
              for (var n = 0, a = r.fonts.length; n < a; ++n) {
                var o = r.fonts[n];
                i.o.push(
                  new S(
                    o.name,
                    M("font-weight:" + o.weight + ";font-style:" + o.style),
                  ),
                );
              }
              t(e);
            }),
            m(this.d, this.H(r), function (e) {
              e && t(!1);
            }))
          : t(!1);
      }),
      ...
      (X.prototype.K = function (e, t) {
        ...
        if (n) {
          var a = r.d.t;
          m(this.d, r.H(n, i), function (i) {
            if (i) t(!1);
            else {
              if (a["__mti_fntLst" + n] && (i = a["__mti_fntLst" + n]()))
                for (var o = 0; o < i.length; o++)
                  r.o.push(new S(i[o].fontfamily));
              t(e.k.X);
            }
      ...
      (X.prototype.H = function (e, t) {
        return (
          c(this.d) +
          "//" +
          (this.f.api || "fast.fonts.net/jsapi").replace(
            /^.*http(s?):(\/\/)?/,
            "",
          ) +
          "/" +
      ...
      ($.prototype.load = function (e) {
        ...
        for (t = 0, r = n.length; t < r; t++) u(this.d, n[t]);
        for (n = [], t = 0, r = i.length; t < r; t++) {
          var o = i[t].split(":");
          if (o[1])
            for (var s = o[1].split(","), l = 0; l < s.length; l += 1)
              n.push(new S(o[0], s[l]));
          else n.push(new S(o[0]));
        }
        e(n, a);
      }),
      ($.prototype.K = function (e, t) {
        return t(e.k.X);
      }));
    var oe = new _(this);
    ((oe.v.w.custom = function (e, t) {
      return new $(t, e);
    }),
      (oe.v.w.fontdeck = function (e, t) {
        return new W(t, e);
      }),
      (oe.v.w.monotype = function (e, t) {
        return new X(t, e);
      }),
      (oe.v.w.typekit = function (e, t) {
        return new Y(t, e);
      }),
      (oe.v.w.google = function (e, t) {
        return new U(t, e);
      }),
      this.WebFont ||
        ((this.WebFont = {}),
        (this.WebFont.load = i(oe.load, oe)),
        this.WebFontConfig && oe.load(this.WebFontConfig)));
  })(this, document),
  ...
  [].slice
    .call(
      document.querySelectorAll('.sl-block[data-block-type="code"] pre code'),
    )
    .forEach(function (e) {
      e.setAttribute("data-plaintext", e.textContent);
    }),
  (function () {
    function e() {
      t ||
  ...
  (SL.fonts = {
    ...
    init: function () {
      if (
        ...
        [].slice
          .call(document.querySelectorAll("link[data-application-font]"))
          .forEach(function (e) {
            var t = e.getAttribute("data-application-font");
            SL.fonts.FAMILIES[t] && (SL.fonts.FAMILIES[t].loaded = !0);
          }),
        SLConfig && SLConfig.deck)
      ) {
        var e = SL.config ? SL.config.DEFAULT_THEME_FONT : "montserrat";
        this.loadDeckFont([SLConfig.deck.theme_font || e], {
    ...
    load: function (e, t) {
      ...
      (SLConfig &&
        SLConfig.deck &&
        (SLConfig.deck.font_typekit &&
          (r.typekit = { id: SLConfig.deck.font_typekit }),
        SLConfig.deck.font_google &&
          ((r.google = r.google || { families: [] }),
          (r.google.families = r.google.families.concat(
            SL.fonts.parseGoogleFontFamilies(SLConfig.deck.font_google),
          )))),
        SLConfig &&
          SLConfig.theme &&
          (SLConfig.theme.font_typekit &&
            (r.typekit = { id: SLConfig.theme.font_typekit }),
          SLConfig.theme.font_google &&
            ((r.google = r.google || { families: [] }),
            (r.google.families = r.google.families.concat(
              SL.fonts.parseGoogleFontFamilies(SLConfig.theme.font_google),
            )))));
      var i = [];
      return (
        r.google &&
          r.google.families &&
          (i = r.google.families.map(function (e) {
            return e.split(":")[0];
          })),
        e.forEach(function (e) {
          var t = SL.fonts.FAMILIES[e];
          t
            ? t.loaded || -1 !== i.indexOf(t.name)
              ? "function" == typeof r.fontactive && r.fontactive(t.name)
              : ((t.loaded = !0),
                r.custom.families.push(t.name),
                r.custom.urls.push(SL.fonts.FONTS_URL + t.path))
            : console.warn('Could not find font family with id "' + e + '"');
        }),
        this.debugMode && console.log("SL.fonts.load", r.custom.families),
        !!(r.custom.families.length || r.typekit || r.google) &&
          (WebFont.load(r), !0)
      );
    },
    loadAll: function (e) {
      var t = [];
      for (var r in SL.fonts.FAMILIES) t.push(r);
      this.load(t, e);
    },
    loadDeckFont: function (e, t) {
      var r = SL.fonts.PACKAGES[e];
      return r ? SL.fonts.load(r, t) : SL.fonts.load([], t);
    },
    loadGoogleFont: function (e) {
      WebFont.load({
        google: { families: SL.fonts.parseGoogleFontFamilies(e) },
      });
    },
    loadGoogleFontPreview: function (e, t) {
      ((this.googlePreviewHistory[e] = this.googlePreviewHistory[e] || []),
        -1 === this.googlePreviewHistory[e].indexOf(t) &&
          (this.googlePreviewHistory[e].push(t),
          WebFont.load({ google: { families: [e], text: t } })));
    },
    loadTypekitFont: function (e) {
      WebFont.load({ typekit: { id: e } });
    },
    parseGoogleFontFamilies: function (e) {
      return (e = (e = (e = (e || "").trim().split(", ")).map(function (e) {
        return e.trim().replace(/(^,)|(,$)/gi, "");
      })).filter(function (e) {
          ...
          [].slice
            .call(
              document.querySelectorAll(
                'link[href="' + SL.fonts.FONTS_URL + t.path + '"]',
              ),
            )
            .forEach(function (e) {
    ...
    finishLoading: function () {
      (clearTimeout(this.initTimeout),
        document.documentElement.classList.add("fonts-are-ready"),
        !1 === this._isReady && ((this._isReady = !0), this.ready.dispatch()),
        this.loaded.dispatch());
    },
    getPackageIDs: function () {
      return Object.keys(SL.fonts.PACKAGES);
    },
    getFamilyByName: function (e) {
      for (var t in SL.fonts.FAMILIES) {
        var r = SL.fonts.FAMILIES[t];
        if (e === r.name) return r;
      }
    },
    isPackageLoaded: function (e) {
      var t = SL.fonts.PACKAGES[e];
      return (
        !t ||
        0 === t.length ||
        t.every(function (e) {
    ...
    onFontActive: function (e) {
      var t = SL.fonts.getFamilyByName(e);
      (t && (t.active = !0), this.fontactive.dispatch(t));
    },
    onFontInactive: function (e) {
      var t = SL.fonts.getFamilyByName(e);
      (t && (t.inactive = !0), this.fontinactive.dispatch(t));
    },
  ...
  (SL("views.decks").Export = Class.extend({
    init: function () {
      (SL.deck.util.injectNotes(),
        SL.deck.util.renderMath(),
        SL.deck.util.injectCodeCopyButtons(),
        window.Reveal && Reveal.isReady() && (Reveal.sync(), Reveal.layout()));
    },
  })),
  (SL("deck").Animation = {
    init: function () {
    ...
    enableAnimations: function () {
      ((this.animationsEnabled = !0),
        this.revealElement.classList.remove("block-animations-disabled"),
        this.reset(this.revealElement));
      var e = Reveal.getCurrentSlide();
      e &&
        this.fastForwardAnimation(
          e,
          function () {
            (this.run(e), this.bind(e));
          }.bind(this),
        );
    },
    disableAnimations: function () {
      ((this.animationsEnabled = !1),
        this.revealElement.classList.add("block-animations-disabled"),
        this.unbind(),
        this.fastForwardAnimation(this.revealElement));
    },
    getAnimationTargets: function (e) {
      return e instanceof Array
        ? e
        : e.hasAttribute("data-animation-type")
          ? [e]
          : [].slice.call(e.querySelectorAll("[data-animation-type]"));
    },
    getInteractiveAnimationTargets: function (e, t) {
      var r = t ? ".animate" : "";
      return [].slice.call(
        e.querySelectorAll(
          [
            '[data-animation-trigger="click"]',
    ...
    run: function (e, t) {
      this.getAnimationTargets(e).forEach(
        function (e) {
          (!t && this.hasInteractiveAnimationTrigger(e)) ||
            ...
            (e.classList.remove("animate"),
              this.fastForwardAnimation(
                ...
                function () {
                  (e.classList.add("animate"),
                    !1 === this.animationsEnabled &&
                      this.revealElement.classList.add(
                        "block-animations-disabled",
                      ));
                }.bind(this),
              ));
          }.bind(this),
    ...
    bind: function (e) {
      (this.unbind(),
        this.getAnimationTargets(e).forEach(
          function (t) {
            if (this.hasInteractiveAnimationTrigger(t)) {
              var r = t.getAttribute("data-animation-trigger-id"),
                n =
                  "self" === r
                    ? t
                    : e.querySelector(
                        '.sl-block[data-block-id="' +
                          r +
                          '"] .sl-block-content',
                      );
              if (n) {
                var i = t.getAttribute("data-animation-trigger");
                "click" === i
                  ? (this.addAnimationEventListener(
                      n,
                      "touchstart",
                      this.onTriggerTouchStart.bind(this, t),
                    ),
                    this.addAnimationEventListener(
                      n,
                      "click",
                      this.onTriggerClick.bind(this, t),
                    ))
                  : "hover" === i &&
                    (this.addAnimationEventListener(
                      n,
                      "mouseover",
                      this.onTriggerMouseOver.bind(this, t),
                    ),
                    this.addAnimationEventListener(
                      n,
                      "mouseout",
                      this.onTriggerMouseOut.bind(this, t),
                    ));
              }
            }
          }.bind(this),
    ...
    addAnimationEventListener: function (e, t, r) {
      (e.addEventListener(t, r),
        /click|touchstart/gi.test(t) && e.classList.add("animation-trigger"),
        this.animationListeners.push([e, t, r]));
    },
    unbind: function () {
      (this.animationListeners.forEach(function (e) {
        var t = e[0],
          r = e[1],
          n = e[2];
        (/click|touchstart/gi.test(r) &&
          t.classList.remove("animation-trigger"),
          t.removeEventListener(r, n));
      }),
        (this.animationListeners.length = 0));
    },
    hasInteractiveAnimationTrigger: function (e) {
      return /click|hover/gi.test(e.getAttribute("data-animation-trigger"));
    },
    fastForwardAnimation: function (e, t) {
      (e.classList.add("no-transition"),
        setTimeout(function () {
          (e.classList.remove("no-transition"), "function" == typeof t && t());
        }, 1));
    },
    getSerializedInteractiveState: function () {
      return this.getInteractiveAnimationTargets(Reveal.getCurrentSlide(), !0)
        .map(function (e) {
          var t = this.getParentBlock(e);
          return t ? t.getAttribute("data-block-id") : null;
        }, this)
        .filter(function (e) {
    ...
    setSerializedInteractiveState: function (e) {
      var t = this.getInteractiveAnimationTargets(Reveal.getCurrentSlide());
      if (t.length && "string" == typeof e) {
        e = e.split(",");
        var r = [],
          n = [];
        (t.forEach(function (t) {
          var i = this.getParentBlock(t),
            a = i ? i.getAttribute("data-block-id") : null;
          "string" == typeof a && -1 !== e.indexOf(a) ? n.push(t) : r.push(t);
        }, this),
          this.reset(r),
          this.run(n, !0));
      }
    ...
    getParentBlock: function (e) {
      for (var t = e.parentNode; t && !t.hasAttribute("data-block-id"); )
        t = t.parentNode;
      return t;
    },
    onSlideChanged: function (e) {
      this.animationsEnabled &&
        (e.previousSlide && (this.reset(e.previousSlide), this.unbind()),
        e.currentSlide &&
          (this.run(e.currentSlide), this.bind(e.currentSlide)));
    },
    onTriggerTouchStart: function (e, t) {
      (t.preventDefault(),
        this.toggle(e, !0),
        this.interactiveAnimationChanged.dispatch());
    },
    onTriggerClick: function (e) {
      (Reveal.isAutoSliding() &&
        Reveal.getConfig().autoSlideStoppable &&
        Reveal.toggleAutoSlide(!1),
        this.toggle(e, !0),
        this.interactiveAnimationChanged.dispatch());
    },
    onTriggerMouseOver: function (e) {
      (this.run(e, !0), this.interactiveAnimationChanged.dispatch());
    },
    onTriggerMouseOut: function (e) {
      (this.reset(e), this.interactiveAnimationChanged.dispatch());
    },
  }),
  (SL("deck").AutoAnimate = {
    ANIMATABLE_BLOCK_CONTENT_STYLES: [
      "color",
      "background-color",
      "padding",
      "font-size",
    ...
    init: function () {
      ((this.onAutoAnimate = this.onAutoAnimate.bind(this)),
        Reveal.addEventListener("autoanimate", this.onAutoAnimate));
    },
    matcher: function (e, t) {
      ...
      SL.deck.AutoAnimate.findMatchingElements(
        ...
        ".sl-block[data-name]",
        function (e) {
          return e.nodeName + ":::" + e.getAttribute("data-name");
        },
      );
      var n = r.map((e) => e.from);
      return (
        SL.deck.AutoAnimate.findMatchingElements(
          r,
          e,
          t,
          '.sl-block[data-block-type="text"], .sl-block[data-block-type="snippet"], .sl-block[data-block-type="table"]',
          function (e) {
            return (
              e.getAttribute("data-block-type") + ":::" + e.textContent.trim()
            );
          },
          null,
          n,
        ...
        SL.deck.AutoAnimate.findMatchingElements(
          ...
          e,
          t,
          '.sl-block[data-block-type="image"], .sl-block[data-block-type="video"]',
          function (e) {
            var t = e.querySelector("img[src], video[src]");
        ...
        SL.deck.AutoAnimate.findMatchingElements(
          ...
          e,
          t,
          '.sl-block[data-block-type="iframe"]',
          function (e) {
            var t = e.querySelector("iframe[src], iframe[data-src]");
            return t
        ...
        SL.deck.AutoAnimate.findMatchingElements(
          ...
          function (e) {
            return e.querySelector(":not(.editing-ui) pre code").textContent;
          },
          null,
          n,
        ),
        SL.deck.AutoAnimate.findMatchingElements(
          ...
          e,
          t,
          '.sl-block[data-block-type="math"]',
          function (e) {
            return e.querySelector(".math-input").textContent;
          },
          null,
          n,
        ),
    ...
    findMatchingElements: function (e, t, r, n, i, a, o) {
      var s = {},
        l = {};
      ([].slice.call(t.querySelectorAll(n)).forEach(function (e) {
        var t = i(e);
        "string" == typeof t && t.length && ((s[t] = s[t] || []), s[t].push(e));
      }),
        [].slice.call(r.querySelectorAll(n)).forEach(function (t) {
          var r,
            n = i(t);
          if (((l[n] = l[n] || []), l[n].push(t), s[n])) {
            var h = l[n].length - 1,
              c = s[n].length - 1;
            s[n][h]
              ? ((r = s[n][h]), (s[n][h] = null))
              : s[n][c] && ((r = s[n][c]), (s[n][c] = null));
          }
          !r ||
            (o && -1 !== o.indexOf(r)) ||
            e.push({ from: r, to: t, options: a || { styles: [] } });
        }));
    },
    expandBlockPairs: function (e) {
      return (
        e.forEach(function (t) {
          ...
          i && a && SL.deck.AutoAnimate.expandBlockPair(e, t, r, n, i, a);
        }),
        e
      );
    },
    expandBlockPair: function (e, t, r, n, i, a) {
      var o = r.querySelector(".sl-block-style"),
        s = n.querySelector(".sl-block-style");
      (o && o.closest(".sl-block") !== r && (o = null),
        s && s.closest(".sl-block") !== n && (s = null));
      var l = r.getAttribute("data-block-type"),
        h = {},
        c = {};
      if (
        (n.dataset.autoAnimateDelay &&
          (t.options.delay = parseFloat(n.dataset.autoAnimateDelay)),
        n.dataset.autoAnimateDuration &&
          (t.options.duration = parseFloat(n.dataset.autoAnimateDuration)),
        n.dataset.autoAnimateEasing &&
          (t.options.easing = n.dataset.autoAnimateEasing),
        (h["z-index"] = {
          property: "z-index",
          from: a.style.zIndex,
          to: a.style.zIndex,
        ...
        const e = s.style.mixBlendMode;
        e &&
          "normal" !== e &&
          (h["mix-blend-mode"] = { property: "mix-blend-mode", to: e });
      }
      return (
        /text|snippet|table|line/i.test(l)
        ...
        o && s
          ? ((h.opacity = {
              property: "opacity",
              from: o.style.opacity || "1",
              to: s.style.opacity || "1",
            }),
              ...
              s.style.transform &&
                ...
                e.push({
                  ...
                  options: {
                    translate: !1,
                    scale: !1,
                    styles: [{ property: "transform", from: "none" }],
                  },
                }))),
        e.push({
          from: i,
        ...
        /text/i.test(l) && this.expandTextBlock(e, t, r, n),
        /code/i.test(l) && this.expandCodeBlock(e, t, r, n),
        /shape/i.test(l) && this.expandShapeBlock(e, t, r, n),
        /line/i.test(l) && this.expandLineBlock(e, t, r, n),
        (t.options.styles = t.options.styles.concat(
          Object.keys(h).map(function (e) {
            return h[e];
          }),
        )),
        (h.width || h.height) && (t.options.scale = !1),
        e
      );
    },
    expandTextBlock: function (e, t, r, n) {
      (SL.deck.AutoAnimate.findMatchingElements(
        e,
        r,
        n,
        ...
        },
        {
          scale: !1,
          translate: !1,
          measure: SL.deck.AutoAnimate.getLocalBlockMeasurements,
        },
      ),
        SL.deck.AutoAnimate.findMatchingElements(
          e,
          ...
          function (e) {
            return Array.prototype.map
              .call(e.childNodes, function (e) {
                return /li|ul|ol/i.test(e.nodeName) ? "" : e.textContent.trim();
              })
              .join("");
          },
    ...
    expandCodeBlock: function (e, t, r, n) {
    ...
    expandShapeBlock: function (e, t, r, n) {
      var i = r.querySelector(".shape-element"),
        a = n.querySelector(".shape-element"),
        o = [{ property: "fill" }, { property: "stroke" }];
      (/rect/i.test(a.nodeName) &&
        o.push({ property: "rx" }, { property: "ry" }),
        i &&
          a &&
          e.push({
            from: i,
            to: a,
            options: { translate: !1, scale: !1, styles: o },
          }));
    },
    expandLineBlock: function (e, t, r, n) {
      var i = [];
      let a = r.querySelector(".line-element"),
        o = n.querySelector(".line-element");
      a && o && i.push([a, o]);
      let s = r.querySelector("path.line-start"),
        l = n.querySelector("path.line-start");
      s && l && i.push([s, l]);
      let h = r.querySelector("path.line-end"),
        c = n.querySelector("path.line-end");
      (h && c && i.push([h, c]),
    ...
    getLocalBlockMeasurements: function (e) {
    ...
    onAutoAnimate: function (e) {
      let t = [];
      (Array.prototype.forEach.call(
        e.toSlide.querySelectorAll(
          '.sl-block[data-auto-animate-target^="unmatched"]',
        ),
        function (e) {
          const r = e.querySelector(".sl-block-content");
          if (r) {
            const n = r.style.zIndex,
              i = e.getAttribute("data-block-id"),
              a = e.getAttribute("data-auto-animate-target");
            t.push(
              `.reveal [data-auto-animate-target="${a}"][data-block-id="${i}"] { z-index: ${n}; }`,
            );
          }
        },
      ),
        t.length && (e.sheet.innerHTML += t.join("")));
    },
  }),
  (SL("deck").Controller = {
    ...
    init: function (e) {
      ((this.options = e || {}),
        (this.options.mode =
          "string" == typeof this.options.mode
            ? this.options.mode
            : SL.deck.Controller.MODE_VIEWING),
        (this.mode = null),
        SL.deck.Media.init(this.options),
        this.options.mode === SL.deck.Controller.MODE_VIEWING &&
          SL.deck.util.formatIframes(),
        Reveal.isReady()
          ? this.setup()
          : Reveal.addEventListener("ready", this.setup.bind(this)));
    },
    setup: function () {
      (SL.deck.Animation.init(),
        SL.deck.AutoAnimate.init(),
        this.setMode(this.options.mode));
    },
    setMode: function (e) {
      ((this.mode = e),
        this.mode === SL.deck.Controller.MODE_EDITING ||
        this.mode === SL.deck.Controller.MODE_PRINTING
          ? SL.deck.Animation.disableAnimations()
          : SL.deck.Animation.enableAnimations());
    },
  }),
  (SL("deck").Media = {
    init: function (e) {
      ((this.options = e),
        this.supportsCDN() &&
          (this.switchToCDN(".reveal img[src], .reveal video[src]", "src"),
          this.switchToCDN(
            ".reveal img[data-src], .reveal video[data-src]",
            "data-src",
          ),
          this.switchToCDN(".reveal video[poster]", "poster"),
          this.switchToCDN(
            ".reveal [data-background-video]",
            "data-background-video",
          ),
          this.switchToCDN(
            ".reveal [data-background-image]",
            "data-background-image",
          )));
    },
    supportsCDN: function () {
      return (
        SL.config &&
        this.options.mode === SL.deck.Controller.MODE_VIEWING &&
        !document.documentElement.classList.contains("sl-editor")
      );
    },
    switchToCDN: function (e, t) {
      document.querySelectorAll(e).forEach(function (e) {
        var r = e.getAttribute(t);
        0 === r.lastIndexOf(SL.config.S3_HOST, 0) &&
          e.setAttribute(t, r.replace(SL.config.S3_HOST, SL.config.CDN_HOST));
      }, this);
    },
    replaceS3HostWithCDN: function (e) {
      return e.replace(SL.config.S3_HOST, SL.config.CDN_HOST);
    },
  }),
  (SL("deck").util = {
    extend: function (e) {
    ...
    renderMath: function (e) {
      (SL.deck.util.renderMathBlocks(e), SL.deck.util.renderInlineMath(e));
    },
    renderMathBlocks: function (e) {
      (e || (e = document.querySelector(".reveal .slides")),
        window.katex &&
          "function" == typeof window.katex.render &&
          [].slice
            .call(e.querySelectorAll('.sl-block[data-block-type="math"]'))
            .forEach(function (e) {
              var t = e.querySelector(".math-input"),
              ...
              if (
                ...
                try {
                  katex.render(t.innerText, r, {
                    displayMode:
                      null !== e.querySelector("[data-math-display=true]"),
                    throwOnError: !0,
                  });
                } catch (n) {
    ...
    renderInlineMath: function (e) {
      (e || (e = document.querySelector(".reveal .slides")),
        "function" == typeof window.renderMathInElement &&
          SL.deck.util.containsInlineMath(e) &&
    ...
    containsInlineMath: function (e) {
      return !!e && /\$\$.+\$\$|\\\[.+\\\]|\\\(.+\\\)/g.test(e.innerHTML);
    },
    injectCodeCopyButtons: function () {
      var e = [].slice.call(
        document.querySelectorAll(
          '.sl-block[data-block-type="code"] .sl-block-content:not(.has-copy-button)',
        ),
      );
      e.length &&
        ...
        this.copyButton.addEventListener(
          ...
          function () {
            this.copyButton.hasAttribute("data-code-to-copy") &&
              ...
              SL.deck.util.copyToClipboard(
                this.copyButton.getAttribute("data-code-to-copy"),
              ),
              setTimeout(
                function () {
                  ((this.copyButton.textContent = "Copy"),
                    this.copyButton.classList.remove("bounce"));
                }.bind(this),
                1500,
              ));
          }.bind(this),
        ...
        e.forEach(function (e) {
          var t,
            r = e.querySelector("pre code");
          (r &&
            (t = r.hasAttribute("data-plaintext")
            ...
            t &&
              e.addEventListener(
                "mouseenter",
                function (e) {
                  (this.copyButton.setAttribute("data-code-to-copy", t),
                    e.currentTarget.classList.add("has-copy-button"),
                    e.currentTarget.appendChild(this.copyButton));
                }.bind(this),
              ));
        }, this));
    },
    hasNotes: function () {
      if (SLConfig.deck && SLConfig.deck.notes)
        for (var e in SLConfig.deck.notes) return !0;
      return (
        document.querySelectorAll(".reveal .slides section[data-notes]")
          .length > 0
      );
    },
    injectNotes: function () {
      SLConfig.deck &&
        ...
        [].forEach.call(
          ...
          function (e) {
            var t = SLConfig.deck.notes[e.getAttribute("data-id")];
            t && "string" == typeof t && e.setAttribute("data-notes", t);
          },
        );
    },
    injectTranslationRules: function () {
      [].slice
        .call(document.querySelectorAll(".sl-block .katex"))
        .forEach(function (e) {
          e.classList.add("notranslate");
        });
    },
    formatIframes: function () {
      [].slice
        .call(document.querySelectorAll(".sl-block iframe[data-src]"))
        .forEach(this.formatIframe.bind(this));
    },
    formatIframe: function (e) {
      (e.removeAttribute("allowfullscreen"),
        e.removeAttribute("webkitallowfullscreen"),
        e.removeAttribute("mozallowfullscreen"));
      let t = [
          "fullscreen",
          "autoplay",
          "accelerometer",
      ...
      ("string" == typeof r
        ...
        : (r = t),
        e.setAttribute("allow", r.join("; ")));
      var n = e.getAttribute("src") || e.getAttribute("data-src");
      "string" != typeof n || /\.pdf$/i.test(n)
        ? e.removeAttribute("sandbox")
        : e.setAttribute(
            "sandbox",
            "allow-forms allow-scripts allow-popups allow-same-origin allow-pointer-lock allow-presentation",
          );
    },
